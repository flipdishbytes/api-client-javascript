...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.CatalogGroupsApi();
  });
  ...
  describe('CatalogGroupsApi', function() {
    describe('archiveGroup', function() {
      it('should call archiveGroup successfully', function(done) {
        //uncomment below and update the code to test archiveGroup
        //instance.archiveGroup(function(error) {
    ...
    describe('duplicateGroup', function() {
      it('should call duplicateGroup successfully', function(done) {
        //uncomment below and update the code to test duplicateGroup
        //instance.duplicateGroup(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
