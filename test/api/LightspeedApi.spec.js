...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.LightspeedApi();
  });
  ...
  describe('LightspeedApi', function() {
    describe('lightspeedGenerateMenu', function() {
      it('should call lightspeedGenerateMenu successfully', function(done) {
        //uncomment below and update the code to test lightspeedGenerateMenu
        //instance.lightspeedGenerateMenu(pet, function(error) {
    ...
    describe('lightspeedGetStoreSettings', function() {
      it('should call lightspeedGetStoreSettings successfully', function(done) {
        //uncomment below and update the code to test lightspeedGetStoreSettings
        //instance.lightspeedGetStoreSettings(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('lightspeedSaveStoreSettings', function() {
      it('should call lightspeedSaveStoreSettings successfully', function(done) {
        //uncomment below and update the code to test lightspeedSaveStoreSettings
        //instance.lightspeedSaveStoreSettings(pet, function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
