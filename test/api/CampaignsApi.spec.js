    ...
    describe('CampaignsApi', function() {
      describe('createLoyaltyCampaign', function() {
        it('should call createLoyaltyCampaign successfully', function(done) {
          ...
          campaign.RoundingStrategy = 0;
          campaign.ShouldIncludeOrdersWithLoyaltyVoucher = false;
          ...
          instance.createLoyaltyCampaign(appId, campaign, function(error, data, response) {
            ...
            expect(data.Data).to.be.a(Flipdish.LoyaltyCampaign);
              ...
              expect(data.Data.RoundingStrategy).to.be.a('number');
              expect(data.Data.RoundingStrategy).to.be(0);
              expect(data.Data.ShouldIncludeOrdersWithLoyaltyVoucher).to.be.a('boolean');
              expect(data.Data.ShouldIncludeOrdersWithLoyaltyVoucher).to.be(false);
              ...
              expect(data.Data.ForceDiscount).to.be.a('boolean');
              expect(data.Data.ForceDiscount).to.be(false);
          ...
          instance.getLoyaltyCampaignsForApp(appId, function(error, data, response) {
            ...
            expect(data).to.be.a(Flipdish.RestApiArrayResultLoyaltyCampaign);
            {
              ...
              for (let p in dataCtr) {
                ...
                expect(data.RoundingStrategy).to.be.a('number');
                expect(data.RoundingStrategy).to.be(0);
                expect(data.ShouldIncludeOrdersWithLoyaltyVoucher).to.be.a('boolean');
                expect(data.ShouldIncludeOrdersWithLoyaltyVoucher).to.be(false);
                ...
                expect(data.ForceDiscount).to.be.a('boolean');
                expect(data.ForceDiscount).to.be(false);
      ...
      describe('getStoreList', function() {
        it('should call getStoreList successfully', function(done) {
          ...
          var appId = "appId_example";
          var opts = {};
          opts.onlyPublished = true;

          instance.getStoreList(appId, opts, function(error, data, response) {
            if (error) {
              done(error);
              return;
            }
