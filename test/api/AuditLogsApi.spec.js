  ...
  describe('AuditLogsApi', function() {
    describe('addOrderAuditLog', function() {
      it('should call addOrderAuditLog successfully', function(done) {
        //uncomment below and update the code to test addOrderAuditLog
        //instance.addOrderAuditLog(function(error) {
    ...
    describe('addStoreAuditLogEvent', function() {
      it('should call addStoreAuditLogEvent successfully', function(done) {
        //uncomment below and update the code to test addStoreAuditLogEvent
        //instance.addStoreAuditLogEvent(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
