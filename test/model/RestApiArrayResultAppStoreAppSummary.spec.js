...
(function(root, factory) {
  ...
  describe('RestApiArrayResultAppStoreAppSummary', function() {
    it('should create an instance of RestApiArrayResultAppStoreAppSummary', function() {
      // uncomment below and update the code to test RestApiArrayResultAppStoreAppSummary
      //var instane = new Flipdish.RestApiArrayResultAppStoreAppSummary();
      //expect(instance).to.be.a(Flipdish.RestApiArrayResultAppStoreAppSummary);
    });

    it('should have the property Data (base name: "Data")', function() {
      // uncomment below and update the code to test the property Data
      //var instance = new Flipdish.RestApiArrayResultAppStoreAppSummary();
