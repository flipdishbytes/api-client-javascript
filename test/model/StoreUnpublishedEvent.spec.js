...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreUnpublishedEvent();
  });
  ...
  describe('StoreUnpublishedEvent', function() {
    it('should create an instance of StoreUnpublishedEvent', function() {
      // uncomment below and update the code to test StoreUnpublishedEvent
      //var instane = new Flipdish.StoreUnpublishedEvent();
      //expect(instance).to.be.a(Flipdish.StoreUnpublishedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreUnpublishedEvent();
