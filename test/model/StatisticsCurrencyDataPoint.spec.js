...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StatisticsCurrencyDataPoint();
  });
  ...
  describe('StatisticsCurrencyDataPoint', function() {
    it('should create an instance of StatisticsCurrencyDataPoint', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StatisticsCurrencyDataPoint();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StatisticsCurrencyDataPoint);
    });
