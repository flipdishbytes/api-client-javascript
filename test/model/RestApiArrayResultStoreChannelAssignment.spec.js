...
(function(root, factory) {
  ...
  describe('RestApiArrayResultStoreChannelAssignment', function() {
    it('should create an instance of RestApiArrayResultStoreChannelAssignment', function() {
      // uncomment below and update the code to test RestApiArrayResultStoreChannelAssignment
      //var instane = new Flipdish.RestApiArrayResultStoreChannelAssignment();
      //expect(instance).to.be.a(Flipdish.RestApiArrayResultStoreChannelAssignment);
    });

    it('should have the property Data (base name: "Data")', function() {
      // uncomment below and update the code to test the property Data
      //var instance = new Flipdish.RestApiArrayResultStoreChannelAssignment();
