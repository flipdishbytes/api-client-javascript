  ...
  describe('(package)', function() {
    describe('MobileAppsSubmissionStatusUpdatedEvent', function() {
      ...
      it('should create an instance of MobileAppsSubmissionStatusUpdatedEvent', function() {
        // TODO: update the code to test MobileAppsSubmissionStatusUpdatedEvent
      ...
      it('should have the property MobileAppsSubmissionStatus (base name: "MobileAppsSubmissionStatus")', function() {
        // TODO: update the code to test the property MobileAppsSubmissionStatus
        expect(instance).to.have.property('MobileAppsSubmissionStatus');
        // expect(instance.MobileAppsSubmissionStatus).to.be(expectedValueLiteral);
      });
