...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppStoreAppConfigurationHeader', function() {
      beforeEach(function() {
        instance = new Flipdish.AppStoreAppConfigurationHeader();
      });

      it('should create an instance of AppStoreAppConfigurationHeader', function() {
        // TODO: update the code to test AppStoreAppConfigurationHeader
        expect(instance).to.be.a(Flipdish.AppStoreAppConfigurationHeader);
      });
