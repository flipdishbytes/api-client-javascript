...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppStoreConfigDeletedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.AppStoreConfigDeletedEvent();
      });

      it('should create an instance of AppStoreConfigDeletedEvent', function() {
        // TODO: update the code to test AppStoreConfigDeletedEvent
        expect(instance).to.be.a(Flipdish.AppStoreConfigDeletedEvent);
      });
