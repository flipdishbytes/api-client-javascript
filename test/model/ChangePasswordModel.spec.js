...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.ChangePasswordModel();
  });
  ...
  describe('ChangePasswordModel', function() {
    it('should create an instance of ChangePasswordModel', function() {
      ...
      //var instane = new FlipdishOpenApiV10.ChangePasswordModel();
      //expect(instance).to.be.a(FlipdishOpenApiV10.ChangePasswordModel);
    });
