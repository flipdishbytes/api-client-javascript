  ...
  describe('(package)', function() {
    describe('AppStoreConfigCreatedEvent', function() {
      ...
      it('should create an instance of AppStoreConfigCreatedEvent', function() {
        // TODO: update the code to test AppStoreConfigCreatedEvent
      ...
      it('should have the property AppStoreAppConfigurationId (base name: "AppStoreAppConfigurationId")', function() {
        // TODO: update the code to test the property AppStoreAppConfigurationId
        expect(instance).to.have.property('AppStoreAppConfigurationId');
        // expect(instance.AppStoreAppConfigurationId).to.be(expectedValueLiteral);
      });
