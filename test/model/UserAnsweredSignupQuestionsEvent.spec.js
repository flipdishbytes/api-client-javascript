  ...
  describe('(package)', function() {
    describe('UserAnsweredSignupQuestionsEvent', function() {
      ...
      it('should create an instance of UserAnsweredSignupQuestionsEvent', function() {
        // TODO: update the code to test UserAnsweredSignupQuestionsEvent
      ...
      it('should have the property SignupAnswers (base name: "SignupAnswers")', function() {
        // TODO: update the code to test the property SignupAnswers
        expect(instance).to.have.property('SignupAnswers');
        // expect(instance.SignupAnswers).to.be(expectedValueLiteral);
      });
