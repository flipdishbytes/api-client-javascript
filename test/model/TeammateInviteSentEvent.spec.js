...
(function(root, factory) {
  ...
  describe('TeammateInviteSentEvent', function() {
    it('should create an instance of TeammateInviteSentEvent', function() {
      // uncomment below and update the code to test TeammateInviteSentEvent
      //var instane = new Flipdish.TeammateInviteSentEvent();
    ...
    it('should have the property Teammate (base name: "Teammate")', function() {
      ...
      //var instance = new Flipdish.TeammateInviteSentEvent();
