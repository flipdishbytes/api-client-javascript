...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.TeammateInviteSentEvent();
  });
  ...
  describe('TeammateInviteSentEvent', function() {
    it('should create an instance of TeammateInviteSentEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.TeammateInviteSentEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.TeammateInviteSentEvent);
    });
