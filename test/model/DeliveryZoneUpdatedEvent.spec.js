...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.DeliveryZoneUpdatedEvent();
  });
  ...
  describe('DeliveryZoneUpdatedEvent', function() {
    it('should create an instance of DeliveryZoneUpdatedEvent', function() {
      // uncomment below and update the code to test DeliveryZoneUpdatedEvent
      //var instane = new Flipdish.DeliveryZoneUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.DeliveryZoneUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.DeliveryZoneUpdatedEvent();
