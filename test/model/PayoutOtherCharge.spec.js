...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.PayoutOtherCharge();
  });
  ...
  describe('PayoutOtherCharge', function() {
    it('should create an instance of PayoutOtherCharge', function() {
      ...
      //var instane = new FlipdishOpenApiV10.PayoutOtherCharge();
      //expect(instance).to.be.a(FlipdishOpenApiV10.PayoutOtherCharge);
    });
