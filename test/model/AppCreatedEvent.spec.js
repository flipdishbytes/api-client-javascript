...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.AppCreatedEvent();
  });
  ...
  describe('AppCreatedEvent', function() {
    it('should create an instance of AppCreatedEvent', function() {
      // uncomment below and update the code to test AppCreatedEvent
      //var instane = new FlipdishOpenApiV10.AppCreatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.AppCreatedEvent);
    });
