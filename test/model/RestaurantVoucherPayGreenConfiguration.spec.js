...
(function(root, factory) {
  ...
  describe('RestaurantVoucherPayGreenConfiguration', function() {
    it('should create an instance of RestaurantVoucherPayGreenConfiguration', function() {
      // uncomment below and update the code to test RestaurantVoucherPayGreenConfiguration
      //var instane = new Flipdish.RestaurantVoucherPayGreenConfiguration();
      //expect(instance).to.be.a(Flipdish.RestaurantVoucherPayGreenConfiguration);
    });

    it('should have the property Name (base name: "Name")', function() {
      // uncomment below and update the code to test the property Name
      //var instance = new Flipdish.RestaurantVoucherPayGreenConfiguration();
      //expect(instance).to.be();
    });

    it('should have the property PayGreenId (base name: "PayGreenId")', function() {
      // uncomment below and update the code to test the property PayGreenId
      //var instance = new Flipdish.RestaurantVoucherPayGreenConfiguration();
      //expect(instance).to.be();
    });
