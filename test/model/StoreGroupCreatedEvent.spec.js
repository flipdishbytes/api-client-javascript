...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreGroupCreatedEvent();
  });
  ...
  describe('StoreGroupCreatedEvent', function() {
    it('should create an instance of StoreGroupCreatedEvent', function() {
      // uncomment below and update the code to test StoreGroupCreatedEvent
      //var instane = new Flipdish.StoreGroupCreatedEvent();
      //expect(instance).to.be.a(Flipdish.StoreGroupCreatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreGroupCreatedEvent();
    ...
    it('should have the property StoreGroup (base name: "StoreGroup")', function() {
      // uncomment below and update the code to test the property StoreGroup
      //var instance = new Flipdish.StoreGroupCreatedEvent();
      //expect(instance).to.be();
    });
