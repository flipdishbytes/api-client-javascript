...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.OrderCustomerTrackingCreatedEvent();
  });
  ...
  describe('OrderCustomerTrackingCreatedEvent', function() {
    it('should create an instance of OrderCustomerTrackingCreatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.OrderCustomerTrackingCreatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.OrderCustomerTrackingCreatedEvent);
    });
