...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.MenuUploadedEvent();
  });
  ...
  describe('MenuUploadedEvent', function() {
    it('should create an instance of MenuUploadedEvent', function() {
      // uncomment below and update the code to test MenuUploadedEvent
      //var instane = new FlipdishOpenApiV10.MenuUploadedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.MenuUploadedEvent);
    });
