...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.UserUpdatedEvent();
  });
  ...
  describe('UserUpdatedEvent', function() {
    it('should create an instance of UserUpdatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.UserUpdatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.UserUpdatedEvent);
    });
