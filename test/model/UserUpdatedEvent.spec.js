...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.UserUpdatedEvent();
  });
  ...
  describe('UserUpdatedEvent', function() {
    it('should create an instance of UserUpdatedEvent', function() {
      // uncomment below and update the code to test UserUpdatedEvent
      //var instane = new Flipdish.UserUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.UserUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.UserUpdatedEvent();
