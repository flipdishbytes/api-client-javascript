...
(function(root, factory) {
  ...
  describe('CreateProductReference', function() {
    it('should create an instance of CreateProductReference', function() {
      // uncomment below and update the code to test CreateProductReference
      //var instane = new Flipdish.CreateProductReference();
    ...
    it('should have the property CatalogItemId (base name: "CatalogItemId")', function() {
      ...
      //var instance = new Flipdish.CreateProductReference();
