...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('CreateProductReference', function() {
      beforeEach(function() {
        instance = new Flipdish.CreateProductReference();
      });

      it('should create an instance of CreateProductReference', function() {
        // TODO: update the code to test CreateProductReference
        expect(instance).to.be.a(Flipdish.CreateProductReference);
      });
