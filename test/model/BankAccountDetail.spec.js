...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.BankAccountDetail();
  });
  ...
  describe('BankAccountDetail', function() {
    it('should create an instance of BankAccountDetail', function() {
      ...
      //var instane = new Flipdish.BankAccountDetail();
      //expect(instance).to.be.a(Flipdish.BankAccountDetail);
    });

    it('should have the property Id (base name: "Id")', function() {
      // uncomment below and update the code to test the property Id
      //var instance = new Flipdish.BankAccountDetail();
