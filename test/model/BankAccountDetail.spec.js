...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.BankAccountDetail();
  });
  ...
  describe('BankAccountDetail', function() {
    it('should create an instance of BankAccountDetail', function() {
      ...
      //var instane = new FlipdishOpenApiV10.BankAccountDetail();
      //expect(instance).to.be.a(FlipdishOpenApiV10.BankAccountDetail);
    });
