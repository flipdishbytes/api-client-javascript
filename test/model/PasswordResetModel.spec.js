...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.PasswordResetModel();
  });
  ...
  describe('PasswordResetModel', function() {
    it('should create an instance of PasswordResetModel', function() {
      ...
      //var instane = new FlipdishOpenApiV10.PasswordResetModel();
      //expect(instance).to.be.a(FlipdishOpenApiV10.PasswordResetModel);
    });
