...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.OrderBatchPublishedEvent();
  });
  ...
  describe('OrderBatchPublishedEvent', function() {
    it('should create an instance of OrderBatchPublishedEvent', function() {
      // uncomment below and update the code to test OrderBatchPublishedEvent
      //var instane = new Flipdish.OrderBatchPublishedEvent();
      //expect(instance).to.be.a(Flipdish.OrderBatchPublishedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.OrderBatchPublishedEvent();
      //expect(instance).to.be();
    });

    it('should have the property OrderBatchId (base name: "OrderBatchId")', function() {
      // uncomment below and update the code to test the property OrderBatchId
      //var instance = new Flipdish.OrderBatchPublishedEvent();
      //expect(instance).to.be();
    });
