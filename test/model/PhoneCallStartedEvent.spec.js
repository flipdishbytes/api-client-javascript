  ...
  describe('(package)', function() {
    describe('PhoneCallStartedEvent', function() {
      ...
      it('should create an instance of PhoneCallStartedEvent', function() {
        // TODO: update the code to test PhoneCallStartedEvent
      ...
      it('should have the property PhoneCall (base name: "PhoneCall")', function() {
        // TODO: update the code to test the property PhoneCall
        expect(instance).to.have.property('PhoneCall');
        // expect(instance.PhoneCall).to.be(expectedValueLiteral);
      });
