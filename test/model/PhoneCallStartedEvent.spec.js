...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.PhoneCallStartedEvent();
  });
  ...
  describe('PhoneCallStartedEvent', function() {
    it('should create an instance of PhoneCallStartedEvent', function() {
      // uncomment below and update the code to test PhoneCallStartedEvent
      //var instane = new Flipdish.PhoneCallStartedEvent();
      //expect(instance).to.be.a(Flipdish.PhoneCallStartedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.PhoneCallStartedEvent();
    ...
    it('should have the property PhoneCall (base name: "PhoneCall")', function() {
      // uncomment below and update the code to test the property PhoneCall
      //var instance = new Flipdish.PhoneCallStartedEvent();
      //expect(instance).to.be();
    });
