...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.PrinterUnassignedFromStoreEvent();
  });
  ...
  describe('PrinterUnassignedFromStoreEvent', function() {
    it('should create an instance of PrinterUnassignedFromStoreEvent', function() {
      // uncomment below and update the code to test PrinterUnassignedFromStoreEvent
      //var instane = new Flipdish.PrinterUnassignedFromStoreEvent();
      //expect(instance).to.be.a(Flipdish.PrinterUnassignedFromStoreEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.PrinterUnassignedFromStoreEvent();
