...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.FlipdishEventBase();
  });
  ...
  describe('FlipdishEventBase', function() {
    it('should create an instance of FlipdishEventBase', function() {
      // uncomment below and update the code to test FlipdishEventBase
      //var instane = new Flipdish.FlipdishEventBase();
      //expect(instance).to.be.a(Flipdish.FlipdishEventBase);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.FlipdishEventBase();
