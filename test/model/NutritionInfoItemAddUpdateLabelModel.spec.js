...
(function(root, factory) {
  ...
  describe('NutritionInfoItemAddUpdateLabelModel', function() {
    it('should create an instance of NutritionInfoItemAddUpdateLabelModel', function() {
      // uncomment below and update the code to test NutritionInfoItemAddUpdateLabelModel
      //var instane = new Flipdish.NutritionInfoItemAddUpdateLabelModel();
      //expect(instance).to.be.a(Flipdish.NutritionInfoItemAddUpdateLabelModel);
    });

    it('should have the property Name (base name: "Name")', function() {
      // uncomment below and update the code to test the property Name
      //var instance = new Flipdish.NutritionInfoItemAddUpdateLabelModel();
