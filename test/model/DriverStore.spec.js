...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.DriverStore();
  });
  ...
  describe('DriverStore', function() {
    it('should create an instance of DriverStore', function() {
      // uncomment below and update the code to test DriverStore
      //var instane = new FlipdishOpenApiV10.DriverStore();
      //expect(instance).to.be.a(FlipdishOpenApiV10.DriverStore);
    });
