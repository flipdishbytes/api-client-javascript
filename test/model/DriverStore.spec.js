...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('DriverStore', function() {
      beforeEach(function() {
        instance = new Flipdish.DriverStore();
      });

      it('should create an instance of DriverStore', function() {
        // TODO: update the code to test DriverStore
        expect(instance).to.be.a(Flipdish.DriverStore);
      });
      ...
      it('should have the property Presence (base name: "Presence")', function() {
        // TODO: update the code to test the property Presence
        expect(instance).to.have.property('Presence');
        // expect(instance.Presence).to.be(expectedValueLiteral);
      });
