...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.LocationAreaCreatedEvent();
  });
  ...
  describe('LocationAreaCreatedEvent', function() {
    it('should create an instance of LocationAreaCreatedEvent', function() {
      // uncomment below and update the code to test LocationAreaCreatedEvent
      //var instane = new Flipdish.LocationAreaCreatedEvent();
      //expect(instance).to.be.a(Flipdish.LocationAreaCreatedEvent);
    });
    ...
    it('should have the property LocationAreaId (base name: "LocationAreaId")', function() {
      ...
      //var instance = new Flipdish.LocationAreaCreatedEvent();
