...
(function(root, factory) {
  ...
  describe('RestApiResultAcceptInvitationResult', function() {
    it('should create an instance of RestApiResultAcceptInvitationResult', function() {
      // uncomment below and update the code to test RestApiResultAcceptInvitationResult
      //var instane = new Flipdish.RestApiResultAcceptInvitationResult();
      //expect(instance).to.be.a(Flipdish.RestApiResultAcceptInvitationResult);
    });

    it('should have the property Data (base name: "Data")', function() {
      // uncomment below and update the code to test the property Data
      //var instance = new Flipdish.RestApiResultAcceptInvitationResult();
