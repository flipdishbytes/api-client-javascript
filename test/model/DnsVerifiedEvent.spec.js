...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.DnsVerifiedEvent();
  });
  ...
  describe('DnsVerifiedEvent', function() {
    it('should create an instance of DnsVerifiedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.DnsVerifiedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.DnsVerifiedEvent);
    });
