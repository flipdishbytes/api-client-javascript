...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.DnsVerifiedEvent();
  });
  ...
  describe('DnsVerifiedEvent', function() {
    it('should create an instance of DnsVerifiedEvent', function() {
      // uncomment below and update the code to test DnsVerifiedEvent
      //var instane = new Flipdish.DnsVerifiedEvent();
      //expect(instance).to.be.a(Flipdish.DnsVerifiedEvent);
    });

    it('should have the property Hostname (base name: "Hostname")', function() {
      // uncomment below and update the code to test the property Hostname
      //var instance = new Flipdish.DnsVerifiedEvent();
