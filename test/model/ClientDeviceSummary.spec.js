...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.ClientDeviceSummary();
  });
  ...
  describe('ClientDeviceSummary', function() {
    it('should create an instance of ClientDeviceSummary', function() {
      // uncomment below and update the code to test ClientDeviceSummary
      //var instane = new Flipdish.ClientDeviceSummary();
      //expect(instance).to.be.a(Flipdish.ClientDeviceSummary);
    });
    ...
    it('should have the property DeviceModel (base name: "DeviceModel")', function() {
      ...
      //var instance = new Flipdish.ClientDeviceSummary();
