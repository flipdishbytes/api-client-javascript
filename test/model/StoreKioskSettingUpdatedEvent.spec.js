...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreKioskSettingUpdatedEvent();
  });
  ...
  describe('StoreKioskSettingUpdatedEvent', function() {
    it('should create an instance of StoreKioskSettingUpdatedEvent', function() {
      // uncomment below and update the code to test StoreKioskSettingUpdatedEvent
      //var instane = new Flipdish.StoreKioskSettingUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.StoreKioskSettingUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreKioskSettingUpdatedEvent();
    ...
    it('should have the property StoreKioskSetting (base name: "StoreKioskSetting")', function() {
      // uncomment below and update the code to test the property StoreKioskSetting
      //var instance = new Flipdish.StoreKioskSettingUpdatedEvent();
      //expect(instance).to.be();
    });
