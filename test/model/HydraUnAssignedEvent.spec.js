  ...
  describe('(package)', function() {
    describe('HydraUnAssignedEvent', function() {
      ...
      it('should create an instance of HydraUnAssignedEvent', function() {
        // TODO: update the code to test HydraUnAssignedEvent
      ...
      it('should have the property HydraStatus (base name: "HydraStatus")', function() {
        // TODO: update the code to test the property HydraStatus
        expect(instance).to.have.property('HydraStatus');
        // expect(instance.HydraStatus).to.be(expectedValueLiteral);
      });
