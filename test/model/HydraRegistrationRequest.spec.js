...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.HydraRegistrationRequest();
  });
  ...
  describe('HydraRegistrationRequest', function() {
    it('should create an instance of HydraRegistrationRequest', function() {
      ...
      //var instane = new FlipdishOpenApiV10.HydraRegistrationRequest();
      //expect(instance).to.be.a(FlipdishOpenApiV10.HydraRegistrationRequest);
    });
