...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.CreateMetadata();
  });
  ...
  describe('CreateMetadata', function() {
    it('should create an instance of CreateMetadata', function() {
      // uncomment below and update the code to test CreateMetadata
      //var instane = new FlipdishOpenApiV10.CreateMetadata();
      //expect(instance).to.be.a(FlipdishOpenApiV10.CreateMetadata);
    });
