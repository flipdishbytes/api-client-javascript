...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('StoreAddressUpdatedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.StoreAddressUpdatedEvent();
      });

      it('should create an instance of StoreAddressUpdatedEvent', function() {
        // TODO: update the code to test StoreAddressUpdatedEvent
        expect(instance).to.be.a(Flipdish.StoreAddressUpdatedEvent);
      });
      ...
      it('should have the property StoreAddress (base name: "StoreAddress")', function() {
        // TODO: update the code to test the property StoreAddress
        expect(instance).to.have.property('StoreAddress');
        // expect(instance.StoreAddress).to.be(expectedValueLiteral);
      });
