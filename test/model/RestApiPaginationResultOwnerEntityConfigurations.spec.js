...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RestApiPaginationResultOwnerEntityConfigurations', function() {
      beforeEach(function() {
        instance = new Flipdish.RestApiPaginationResultOwnerEntityConfigurations();
      });

      it('should create an instance of RestApiPaginationResultOwnerEntityConfigurations', function() {
        // TODO: update the code to test RestApiPaginationResultOwnerEntityConfigurations
        expect(instance).to.be.a(Flipdish.RestApiPaginationResultOwnerEntityConfigurations);
      });
