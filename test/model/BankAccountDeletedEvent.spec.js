...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.BankAccountDeletedEvent();
  });
  ...
  describe('BankAccountDeletedEvent', function() {
    it('should create an instance of BankAccountDeletedEvent', function() {
      // uncomment below and update the code to test BankAccountDeletedEvent
      //var instane = new Flipdish.BankAccountDeletedEvent();
      //expect(instance).to.be.a(Flipdish.BankAccountDeletedEvent);
    });

    it('should have the property OrgId (base name: "OrgId")', function() {
      // uncomment below and update the code to test the property OrgId
      //var instance = new Flipdish.BankAccountDeletedEvent();
