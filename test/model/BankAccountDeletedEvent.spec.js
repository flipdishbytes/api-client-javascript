...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.BankAccountDeletedEvent();
  });
  ...
  describe('BankAccountDeletedEvent', function() {
    it('should create an instance of BankAccountDeletedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.BankAccountDeletedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.BankAccountDeletedEvent);
    });
