...
(function(root, factory) {
  ...
  describe('RestApiResultOrderIngestSubmitOrderResponse', function() {
    it('should create an instance of RestApiResultOrderIngestSubmitOrderResponse', function() {
      // uncomment below and update the code to test RestApiResultOrderIngestSubmitOrderResponse
      //var instane = new Flipdish.RestApiResultOrderIngestSubmitOrderResponse();
      //expect(instance).to.be.a(Flipdish.RestApiResultOrderIngestSubmitOrderResponse);
    });

    it('should have the property Data (base name: "Data")', function() {
      // uncomment below and update the code to test the property Data
      //var instance = new Flipdish.RestApiResultOrderIngestSubmitOrderResponse();
