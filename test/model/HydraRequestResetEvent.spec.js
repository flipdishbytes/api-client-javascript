...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.HydraRequestResetEvent();
  });
  ...
  describe('HydraRequestResetEvent', function() {
    it('should create an instance of HydraRequestResetEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.HydraRequestResetEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.HydraRequestResetEvent);
    });
