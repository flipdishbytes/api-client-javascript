...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StripeConnectedAccountInfo();
  });
  ...
  describe('StripeConnectedAccountInfo', function() {
    it('should create an instance of StripeConnectedAccountInfo', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StripeConnectedAccountInfo();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StripeConnectedAccountInfo);
    });
