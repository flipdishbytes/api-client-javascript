...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PushNotificationDeletedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.PushNotificationDeletedEvent();
      });

      it('should create an instance of PushNotificationDeletedEvent', function() {
        // TODO: update the code to test PushNotificationDeletedEvent
        expect(instance).to.be.a(Flipdish.PushNotificationDeletedEvent);
      });
