...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.LoyaltyCampaign();
  });
  ...
  describe('LoyaltyCampaign', function() {
    it('should create an instance of LoyaltyCampaign', function() {
      ...
      //var instane = new FlipdishOpenApiV10.LoyaltyCampaign();
      //expect(instance).to.be.a(FlipdishOpenApiV10.LoyaltyCampaign);
    });
