...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.BalanceDetails();
  });
  ...
  describe('BalanceDetails', function() {
    it('should create an instance of BalanceDetails', function() {
      ...
      //var instane = new FlipdishOpenApiV10.BalanceDetails();
      //expect(instance).to.be.a(FlipdishOpenApiV10.BalanceDetails);
    });
