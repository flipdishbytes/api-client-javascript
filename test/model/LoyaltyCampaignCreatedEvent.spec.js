...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.LoyaltyCampaignCreatedEvent();
  });
  ...
  describe('LoyaltyCampaignCreatedEvent', function() {
    it('should create an instance of LoyaltyCampaignCreatedEvent', function() {
      // uncomment below and update the code to test LoyaltyCampaignCreatedEvent
      //var instane = new Flipdish.LoyaltyCampaignCreatedEvent();
      //expect(instance).to.be.a(Flipdish.LoyaltyCampaignCreatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.LoyaltyCampaignCreatedEvent();
