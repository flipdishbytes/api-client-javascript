...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreOrderCapacityConfigEditModel();
  });
  ...
  describe('StoreOrderCapacityConfigEditModel', function() {
    it('should create an instance of StoreOrderCapacityConfigEditModel', function() {
      // uncomment below and update the code to test StoreOrderCapacityConfigEditModel
      //var instane = new FlipdishOpenApiV10.StoreOrderCapacityConfigEditModel();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreOrderCapacityConfigEditModel);
    });
