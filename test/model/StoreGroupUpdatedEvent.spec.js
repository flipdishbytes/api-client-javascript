...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreGroupUpdatedEvent();
  });
  ...
  describe('StoreGroupUpdatedEvent', function() {
    it('should create an instance of StoreGroupUpdatedEvent', function() {
      // uncomment below and update the code to test StoreGroupUpdatedEvent
      //var instane = new FlipdishOpenApiV10.StoreGroupUpdatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreGroupUpdatedEvent);
    });
