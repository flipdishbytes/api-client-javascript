...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.MenuTaxDetails();
  });
  ...
  describe('MenuTaxDetails', function() {
    it('should create an instance of MenuTaxDetails', function() {
      ...
      //var instane = new FlipdishOpenApiV10.MenuTaxDetails();
      //expect(instance).to.be.a(FlipdishOpenApiV10.MenuTaxDetails);
    });
