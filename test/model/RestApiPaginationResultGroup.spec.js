...
(function(root, factory) {
  ...
  describe('RestApiPaginationResultGroup', function() {
    it('should create an instance of RestApiPaginationResultGroup', function() {
      // uncomment below and update the code to test RestApiPaginationResultGroup
      //var instane = new Flipdish.RestApiPaginationResultGroup();
      //expect(instance).to.be.a(Flipdish.RestApiPaginationResultGroup);
    });

    it('should have the property Page (base name: "Page")', function() {
      // uncomment below and update the code to test the property Page
      //var instance = new Flipdish.RestApiPaginationResultGroup();
