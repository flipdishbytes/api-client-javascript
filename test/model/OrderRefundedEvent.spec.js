...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.OrderRefundedEvent();
  });
  ...
  describe('OrderRefundedEvent', function() {
    it('should create an instance of OrderRefundedEvent', function() {
      // uncomment below and update the code to test OrderRefundedEvent
      //var instane = new Flipdish.OrderRefundedEvent();
      //expect(instance).to.be.a(Flipdish.OrderRefundedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.OrderRefundedEvent();
