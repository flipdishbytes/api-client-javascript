  ...
  describe('(package)', function() {
    describe('StoreOpeningHoursUpdatedEvent', function() {
      ...
      it('should create an instance of StoreOpeningHoursUpdatedEvent', function() {
        // TODO: update the code to test StoreOpeningHoursUpdatedEvent
      ...
      it('should have the property BusinessHoursPeriodOld (base name: "BusinessHoursPeriodOld")', function() {
        // TODO: update the code to test the property BusinessHoursPeriodOld
        expect(instance).to.have.property('BusinessHoursPeriodOld');
        // expect(instance.BusinessHoursPeriodOld).to.be(expectedValueLiteral);
      });

      it('should have the property BusinessHoursPeriod (base name: "BusinessHoursPeriod")', function() {
        // TODO: update the code to test the property BusinessHoursPeriod
        expect(instance).to.have.property('BusinessHoursPeriod');
        // expect(instance.BusinessHoursPeriod).to.be(expectedValueLiteral);
      });
