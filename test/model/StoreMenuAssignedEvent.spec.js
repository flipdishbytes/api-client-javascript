...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreMenuAssignedEvent();
  });
  ...
  describe('StoreMenuAssignedEvent', function() {
    it('should create an instance of StoreMenuAssignedEvent', function() {
      // uncomment below and update the code to test StoreMenuAssignedEvent
      //var instane = new Flipdish.StoreMenuAssignedEvent();
      //expect(instance).to.be.a(Flipdish.StoreMenuAssignedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreMenuAssignedEvent();
