...
(function(root, factory) {
  ...
  describe('CreateFulfillmentStatesConfiguration', function() {
    it('should create an instance of CreateFulfillmentStatesConfiguration', function() {
      // uncomment below and update the code to test CreateFulfillmentStatesConfiguration
      //var instane = new Flipdish.CreateFulfillmentStatesConfiguration();
    ...
    it('should have the property StoreIds (base name: "StoreIds")', function() {
      ...
      //var instance = new Flipdish.CreateFulfillmentStatesConfiguration();
