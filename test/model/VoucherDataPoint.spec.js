...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.VoucherDataPoint();
  });
  ...
  describe('VoucherDataPoint', function() {
    it('should create an instance of VoucherDataPoint', function() {
      // uncomment below and update the code to test VoucherDataPoint
      //var instane = new FlipdishOpenApiV10.VoucherDataPoint();
      //expect(instance).to.be.a(FlipdishOpenApiV10.VoucherDataPoint);
    });
