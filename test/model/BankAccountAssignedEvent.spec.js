...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.BankAccountAssignedEvent();
  });
  ...
  describe('BankAccountAssignedEvent', function() {
    it('should create an instance of BankAccountAssignedEvent', function() {
      // uncomment below and update the code to test BankAccountAssignedEvent
      //var instane = new Flipdish.BankAccountAssignedEvent();
