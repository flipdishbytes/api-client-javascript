...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.CertificateRenewedEvent();
  });
  ...
  describe('CertificateRenewedEvent', function() {
    it('should create an instance of CertificateRenewedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.CertificateRenewedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.CertificateRenewedEvent);
    });
