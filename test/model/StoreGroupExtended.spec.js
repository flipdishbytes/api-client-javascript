...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreGroupExtended();
  });
  ...
  describe('StoreGroupExtended', function() {
    it('should create an instance of StoreGroupExtended', function() {
      // uncomment below and update the code to test StoreGroupExtended
      //var instane = new FlipdishOpenApiV10.StoreGroupExtended();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreGroupExtended);
    });
    ...
    it('should have the property groupedCoordinates (base name: "GroupedCoordinates")', function() {
      // uncomment below and update the code to test the property groupedCoordinates
      //var instane = new FlipdishOpenApiV10.StoreGroupExtended();
      //expect(instance).to.be();
    });

    it('should have the property storeHeaders (base name: "StoreHeaders")', function() {
      // uncomment below and update the code to test the property storeHeaders
      //var instane = new FlipdishOpenApiV10.StoreGroupExtended();
      //expect(instance).to.be();
    });
