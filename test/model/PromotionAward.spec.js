...
(function(root, factory) {
  ...
  describe('PromotionAward', function() {
    it('should create an instance of PromotionAward', function() {
      // uncomment below and update the code to test PromotionAward
      //var instane = new Flipdish.PromotionAward();
    ...
    it('should have the property PromotionAwardId (base name: "PromotionAwardId")', function() {
      // uncomment below and update the code to test the property PromotionAwardId
      //var instance = new Flipdish.PromotionAward();
