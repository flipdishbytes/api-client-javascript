...
(function(root, factory) {
  ...
  describe('KioskEntitlementsResult', function() {
    it('should create an instance of KioskEntitlementsResult', function() {
      // uncomment below and update the code to test KioskEntitlementsResult
      //var instane = new Flipdish.KioskEntitlementsResult();
    ...
    it('should have the property EntitledQuantity (base name: "EntitledQuantity")', function() {
      // uncomment below and update the code to test the property EntitledQuantity
      //var instance = new Flipdish.KioskEntitlementsResult();
