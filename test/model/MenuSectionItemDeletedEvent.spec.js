...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MenuSectionItemDeletedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.MenuSectionItemDeletedEvent();
      });

      it('should create an instance of MenuSectionItemDeletedEvent', function() {
        // TODO: update the code to test MenuSectionItemDeletedEvent
        expect(instance).to.be.a(Flipdish.MenuSectionItemDeletedEvent);
      });
