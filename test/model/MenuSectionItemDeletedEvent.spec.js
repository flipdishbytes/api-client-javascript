...
(function(root, factory) {
  ...
  describe('MenuSectionItemDeletedEvent', function() {
    it('should create an instance of MenuSectionItemDeletedEvent', function() {
      // uncomment below and update the code to test MenuSectionItemDeletedEvent
      //var instane = new Flipdish.MenuSectionItemDeletedEvent();
    ...
    it('should have the property MenuId (base name: "MenuId")', function() {
      ...
      //var instance = new Flipdish.MenuSectionItemDeletedEvent();
