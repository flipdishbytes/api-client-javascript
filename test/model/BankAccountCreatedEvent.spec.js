...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.BankAccountCreatedEvent();
  });
  ...
  describe('BankAccountCreatedEvent', function() {
    it('should create an instance of BankAccountCreatedEvent', function() {
      // uncomment below and update the code to test BankAccountCreatedEvent
      //var instane = new FlipdishOpenApiV10.BankAccountCreatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.BankAccountCreatedEvent);
    });
