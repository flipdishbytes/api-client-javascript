...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RestApiPaginationResultPayoutReport3PayoutOrder', function() {
      beforeEach(function() {
        instance = new Flipdish.RestApiPaginationResultPayoutReport3PayoutOrder();
      });

      it('should create an instance of RestApiPaginationResultPayoutReport3PayoutOrder', function() {
        // TODO: update the code to test RestApiPaginationResultPayoutReport3PayoutOrder
        expect(instance).to.be.a(Flipdish.RestApiPaginationResultPayoutReport3PayoutOrder);
      });
