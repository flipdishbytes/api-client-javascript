...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.UserStoreInfo();
  });
  ...
  describe('UserStoreInfo', function() {
    it('should create an instance of UserStoreInfo', function() {
      // uncomment below and update the code to test UserStoreInfo
      //var instane = new Flipdish.UserStoreInfo();
      //expect(instance).to.be.a(Flipdish.UserStoreInfo);
    });
    ...
    it('should have the property PropertyId (base name: "PropertyId")', function() {
      ...
      //var instance = new Flipdish.UserStoreInfo();
