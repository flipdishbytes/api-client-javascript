...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.PaymentTerminalTransactionDetails();
  });
  ...
  describe('PaymentTerminalTransactionDetails', function() {
    it('should create an instance of PaymentTerminalTransactionDetails', function() {
      ...
      //var instane = new FlipdishOpenApiV10.PaymentTerminalTransactionDetails();
      //expect(instance).to.be.a(FlipdishOpenApiV10.PaymentTerminalTransactionDetails);
    });
