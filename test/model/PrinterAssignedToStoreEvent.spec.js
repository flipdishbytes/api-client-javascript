...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.PrinterAssignedToStoreEvent();
  });
  ...
  describe('PrinterAssignedToStoreEvent', function() {
    it('should create an instance of PrinterAssignedToStoreEvent', function() {
      // uncomment below and update the code to test PrinterAssignedToStoreEvent
      //var instane = new Flipdish.PrinterAssignedToStoreEvent();
      //expect(instance).to.be.a(Flipdish.PrinterAssignedToStoreEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.PrinterAssignedToStoreEvent();
