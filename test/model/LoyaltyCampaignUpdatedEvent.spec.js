...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.LoyaltyCampaignUpdatedEvent();
  });
  ...
  describe('LoyaltyCampaignUpdatedEvent', function() {
    it('should create an instance of LoyaltyCampaignUpdatedEvent', function() {
      // uncomment below and update the code to test LoyaltyCampaignUpdatedEvent
      //var instane = new FlipdishOpenApiV10.LoyaltyCampaignUpdatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.LoyaltyCampaignUpdatedEvent);
    });
