...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.CreateCatalogItem();
  });
  ...
  describe('CreateCatalogItem', function() {
    it('should create an instance of CreateCatalogItem', function() {
      // uncomment below and update the code to test CreateCatalogItem
      //var instane = new Flipdish.CreateCatalogItem();
      //expect(instance).to.be.a(Flipdish.CreateCatalogItem);
    });

    it('should have the property Groups (base name: "Groups")', function() {
      // uncomment below and update the code to test the property Groups
      //var instance = new Flipdish.CreateCatalogItem();
