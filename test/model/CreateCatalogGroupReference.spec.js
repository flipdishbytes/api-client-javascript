...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.CreateCatalogGroupReference();
  });
  ...
  describe('CreateCatalogGroupReference', function() {
    it('should create an instance of CreateCatalogGroupReference', function() {
      // uncomment below and update the code to test CreateCatalogGroupReference
      //var instane = new Flipdish.CreateCatalogGroupReference();
      //expect(instance).to.be.a(Flipdish.CreateCatalogGroupReference);
    });
    ...
    it('should have the property CatalogGroupId (base name: "CatalogGroupId")', function() {
      ...
      //var instance = new Flipdish.CreateCatalogGroupReference();
