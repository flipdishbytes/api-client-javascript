...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppDetailBase', function() {
      beforeEach(function() {
        instance = new Flipdish.AppDetailBase();
      });

      it('should create an instance of AppDetailBase', function() {
        // TODO: update the code to test AppDetailBase
        expect(instance).to.be.a(Flipdish.AppDetailBase);
      });
