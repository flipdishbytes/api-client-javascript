...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.VoucherCreatedEvent();
  });
  ...
  describe('VoucherCreatedEvent', function() {
    it('should create an instance of VoucherCreatedEvent', function() {
      // uncomment below and update the code to test VoucherCreatedEvent
      //var instane = new Flipdish.VoucherCreatedEvent();
      //expect(instance).to.be.a(Flipdish.VoucherCreatedEvent);
    });
    ...
    it('should have the property VoucherId (base name: "VoucherId")', function() {
      ...
      //var instance = new Flipdish.VoucherCreatedEvent();
