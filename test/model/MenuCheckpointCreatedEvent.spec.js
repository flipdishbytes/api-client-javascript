...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.MenuCheckpointCreatedEvent();
  });
  ...
  describe('MenuCheckpointCreatedEvent', function() {
    it('should create an instance of MenuCheckpointCreatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.MenuCheckpointCreatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.MenuCheckpointCreatedEvent);
    });
