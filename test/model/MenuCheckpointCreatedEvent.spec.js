...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.MenuCheckpointCreatedEvent();
  });
  ...
  describe('MenuCheckpointCreatedEvent', function() {
    it('should create an instance of MenuCheckpointCreatedEvent', function() {
      // uncomment below and update the code to test MenuCheckpointCreatedEvent
      //var instane = new Flipdish.MenuCheckpointCreatedEvent();
      //expect(instance).to.be.a(Flipdish.MenuCheckpointCreatedEvent);
    });

    it('should have the property Description (base name: "Description")', function() {
      // uncomment below and update the code to test the property Description
      //var instance = new Flipdish.MenuCheckpointCreatedEvent();
