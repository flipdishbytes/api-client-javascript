  ...
  describe('(package)', function() {
    describe('WebhookSubscriptionUpdatedEvent', function() {
      ...
      it('should create an instance of WebhookSubscriptionUpdatedEvent', function() {
        // TODO: update the code to test WebhookSubscriptionUpdatedEvent
      ...
      it('should have the property WebhookSubscriptionEventInfo (base name: "WebhookSubscriptionEventInfo")', function() {
        // TODO: update the code to test the property WebhookSubscriptionEventInfo
        expect(instance).to.have.property('WebhookSubscriptionEventInfo');
        // expect(instance.WebhookSubscriptionEventInfo).to.be(expectedValueLiteral);
      });
