  ...
  describe('(package)', function() {
    describe('OrderCapacityConfigUpdatedEvent', function() {
      ...
      it('should create an instance of OrderCapacityConfigUpdatedEvent', function() {
        // TODO: update the code to test OrderCapacityConfigUpdatedEvent
      ...
      it('should have the property OrderCapacityConfig (base name: "OrderCapacityConfig")', function() {
        // TODO: update the code to test the property OrderCapacityConfig
        expect(instance).to.have.property('OrderCapacityConfig');
        // expect(instance.OrderCapacityConfig).to.be(expectedValueLiteral);
      });
