...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.OrderCapacityConfigUpdatedEvent();
  });
  ...
  describe('OrderCapacityConfigUpdatedEvent', function() {
    it('should create an instance of OrderCapacityConfigUpdatedEvent', function() {
      // uncomment below and update the code to test OrderCapacityConfigUpdatedEvent
      //var instane = new Flipdish.OrderCapacityConfigUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.OrderCapacityConfigUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.OrderCapacityConfigUpdatedEvent();
    ...
    it('should have the property OrderCapacityConfig (base name: "OrderCapacityConfig")', function() {
      // uncomment below and update the code to test the property OrderCapacityConfig
      //var instance = new Flipdish.OrderCapacityConfigUpdatedEvent();
      //expect(instance).to.be();
    });
