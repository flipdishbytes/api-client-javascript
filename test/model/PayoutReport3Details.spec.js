...
(function(root, factory) {
  ...
  describe('PayoutReport3Details', function() {
    it('should create an instance of PayoutReport3Details', function() {
      // uncomment below and update the code to test PayoutReport3Details
      //var instane = new Flipdish.PayoutReport3Details();
      //expect(instance).to.be.a(Flipdish.PayoutReport3Details);
    });

    it('should have the property Amount (base name: "Amount")', function() {
      // uncomment below and update the code to test the property Amount
      //var instance = new Flipdish.PayoutReport3Details();
