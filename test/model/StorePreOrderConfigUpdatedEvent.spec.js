  ...
  describe('(package)', function() {
    describe('StorePreOrderConfigUpdatedEvent', function() {
      ...
      it('should create an instance of StorePreOrderConfigUpdatedEvent', function() {
        // TODO: update the code to test StorePreOrderConfigUpdatedEvent
      ...
      it('should have the property PreOrderConfig (base name: "PreOrderConfig")', function() {
        // TODO: update the code to test the property PreOrderConfig
        expect(instance).to.have.property('PreOrderConfig');
