...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.CreateTeammate();
  });
  ...
  describe('CreateTeammate', function() {
    it('should create an instance of CreateTeammate', function() {
      ...
      //var instane = new FlipdishOpenApiV10.CreateTeammate();
      //expect(instance).to.be.a(FlipdishOpenApiV10.CreateTeammate);
    });
