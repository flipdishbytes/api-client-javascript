  ...
  describe('(package)', function() {
    describe('WebsiteUpdatedEvent', function() {
      ...
      it('should create an instance of WebsiteUpdatedEvent', function() {
        // TODO: update the code to test WebsiteUpdatedEvent
        expect(instance).to.be.a(Flipdish.WebsiteUpdatedEvent);
      });

      it('should have the property AppNameId (base name: "AppNameId")', function() {
        // TODO: update the code to test the property AppNameId
        expect(instance).to.have.property('AppNameId');
        // expect(instance.AppNameId).to.be(expectedValueLiteral);
      });
