...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.RetentionCampaignCreatedEvent();
  });
  ...
  describe('RetentionCampaignCreatedEvent', function() {
    it('should create an instance of RetentionCampaignCreatedEvent', function() {
      // uncomment below and update the code to test RetentionCampaignCreatedEvent
      //var instane = new Flipdish.RetentionCampaignCreatedEvent();
      //expect(instance).to.be.a(Flipdish.RetentionCampaignCreatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.RetentionCampaignCreatedEvent();
