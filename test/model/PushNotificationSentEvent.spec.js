...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PushNotificationSentEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.PushNotificationSentEvent();
      });

      it('should create an instance of PushNotificationSentEvent', function() {
        // TODO: update the code to test PushNotificationSentEvent
        expect(instance).to.be.a(Flipdish.PushNotificationSentEvent);
      });
