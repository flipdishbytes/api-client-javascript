...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.HttpPostedFileBase();
  });
  ...
  describe('HttpPostedFileBase', function() {
    it('should create an instance of HttpPostedFileBase', function() {
      // uncomment below and update the code to test HttpPostedFileBase
      //var instane = new Flipdish.HttpPostedFileBase();
      //expect(instance).to.be.a(Flipdish.HttpPostedFileBase);
    });
    ...
    it('should have the property ContentLength (base name: "ContentLength")', function() {
      ...
      //var instance = new Flipdish.HttpPostedFileBase();
