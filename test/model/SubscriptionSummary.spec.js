...
(function(root, factory) {
  ...
  describe('SubscriptionSummary', function() {
    it('should create an instance of SubscriptionSummary', function() {
      // uncomment below and update the code to test SubscriptionSummary
      //var instane = new Flipdish.SubscriptionSummary();
    ...
    it('should have the property NextInvoiceAmount (base name: "NextInvoiceAmount")', function() {
      ...
      //var instance = new Flipdish.SubscriptionSummary();
