...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.KioskBluetoothTerminalInitiateUpdateCheckEvent();
  });
  ...
  describe('KioskBluetoothTerminalInitiateUpdateCheckEvent', function() {
    it('should create an instance of KioskBluetoothTerminalInitiateUpdateCheckEvent', function() {
      // uncomment below and update the code to test KioskBluetoothTerminalInitiateUpdateCheckEvent
      //var instane = new Flipdish.KioskBluetoothTerminalInitiateUpdateCheckEvent();
      //expect(instance).to.be.a(Flipdish.KioskBluetoothTerminalInitiateUpdateCheckEvent);
    });
