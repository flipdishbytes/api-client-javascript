...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.OrderRatingUpdatedEvent();
  });
  ...
  describe('OrderRatingUpdatedEvent', function() {
    it('should create an instance of OrderRatingUpdatedEvent', function() {
      // uncomment below and update the code to test OrderRatingUpdatedEvent
      //var instane = new Flipdish.OrderRatingUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.OrderRatingUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.OrderRatingUpdatedEvent();
