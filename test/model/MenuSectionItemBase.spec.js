...
(function(root, factory) {
  ...
  describe('MenuSectionItemBase', function() {
    it('should create an instance of MenuSectionItemBase', function() {
      // uncomment below and update the code to test MenuSectionItemBase
      //var instane = new Flipdish.MenuSectionItemBase();
      //expect(instance).to.be.a(Flipdish.MenuSectionItemBase);
    });

    it('should have the property Name (base name: "Name")', function() {
      // uncomment below and update the code to test the property Name
      //var instance = new Flipdish.MenuSectionItemBase();
