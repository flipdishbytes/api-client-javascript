...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MenuSectionDeletedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.MenuSectionDeletedEvent();
      });

      it('should create an instance of MenuSectionDeletedEvent', function() {
        // TODO: update the code to test MenuSectionDeletedEvent
        expect(instance).to.be.a(Flipdish.MenuSectionDeletedEvent);
      });
