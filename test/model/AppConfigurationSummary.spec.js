...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppConfigurationSummary', function() {
      beforeEach(function() {
        instance = new Flipdish.AppConfigurationSummary();
      });

      it('should create an instance of AppConfigurationSummary', function() {
        // TODO: update the code to test AppConfigurationSummary
        expect(instance).to.be.a(Flipdish.AppConfigurationSummary);
      });
