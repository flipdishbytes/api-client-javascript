...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreTipUpdatedEvent();
  });
  ...
  describe('StoreTipUpdatedEvent', function() {
    it('should create an instance of StoreTipUpdatedEvent', function() {
      // uncomment below and update the code to test StoreTipUpdatedEvent
      //var instane = new Flipdish.StoreTipUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.StoreTipUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreTipUpdatedEvent();
