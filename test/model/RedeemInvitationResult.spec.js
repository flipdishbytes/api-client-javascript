...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.RedeemInvitationResult();
  });
  ...
  describe('RedeemInvitationResult', function() {
    it('should create an instance of RedeemInvitationResult', function() {
      // uncomment below and update the code to test RedeemInvitationResult
      //var instane = new FlipdishOpenApiV10.RedeemInvitationResult();
      //expect(instance).to.be.a(FlipdishOpenApiV10.RedeemInvitationResult);
    });
