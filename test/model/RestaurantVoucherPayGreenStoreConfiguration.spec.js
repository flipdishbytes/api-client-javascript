...
(function(root, factory) {
  ...
  describe('RestaurantVoucherPayGreenStoreConfiguration', function() {
    it('should create an instance of RestaurantVoucherPayGreenStoreConfiguration', function() {
      // uncomment below and update the code to test RestaurantVoucherPayGreenStoreConfiguration
      //var instane = new Flipdish.RestaurantVoucherPayGreenStoreConfiguration();
      //expect(instance).to.be.a(Flipdish.RestaurantVoucherPayGreenStoreConfiguration);
    });

    it('should have the property Name (base name: "Name")', function() {
      // uncomment below and update the code to test the property Name
      //var instance = new Flipdish.RestaurantVoucherPayGreenStoreConfiguration();
