...
(function(root, factory) {
  ...
  describe('ClientDeviceEnrollmentResult', function() {
    it('should create an instance of ClientDeviceEnrollmentResult', function() {
      // uncomment below and update the code to test ClientDeviceEnrollmentResult
      //var instane = new Flipdish.ClientDeviceEnrollmentResult();
    ...
    it('should have the property PinCode (base name: "PinCode")', function() {
      ...
      //var instance = new Flipdish.ClientDeviceEnrollmentResult();
