...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.MenuItemOptionSetDeletedEvent();
  });
  ...
  describe('MenuItemOptionSetDeletedEvent', function() {
    it('should create an instance of MenuItemOptionSetDeletedEvent', function() {
      // uncomment below and update the code to test MenuItemOptionSetDeletedEvent
      //var instane = new Flipdish.MenuItemOptionSetDeletedEvent();
      //expect(instance).to.be.a(Flipdish.MenuItemOptionSetDeletedEvent);
    });
    ...
    it('should have the property MenuId (base name: "MenuId")', function() {
      ...
      //var instance = new Flipdish.MenuItemOptionSetDeletedEvent();
    ...
    it('should have the property MenuItemOptionSet (base name: "MenuItemOptionSet")', function() {
      // uncomment below and update the code to test the property MenuItemOptionSet
      //var instance = new Flipdish.MenuItemOptionSetDeletedEvent();
      //expect(instance).to.be();
    });
