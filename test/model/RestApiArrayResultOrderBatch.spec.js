...
(function(root, factory) {
  ...
  describe('RestApiArrayResultOrderBatch', function() {
    it('should create an instance of RestApiArrayResultOrderBatch', function() {
      // uncomment below and update the code to test RestApiArrayResultOrderBatch
      //var instane = new Flipdish.RestApiArrayResultOrderBatch();
      //expect(instance).to.be.a(Flipdish.RestApiArrayResultOrderBatch);
    });

    it('should have the property Data (base name: "Data")', function() {
      // uncomment below and update the code to test the property Data
      //var instance = new Flipdish.RestApiArrayResultOrderBatch();
