...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.PrinterTurnedOffEvent();
  });
  ...
  describe('PrinterTurnedOffEvent', function() {
    it('should create an instance of PrinterTurnedOffEvent', function() {
      // uncomment below and update the code to test PrinterTurnedOffEvent
      //var instane = new Flipdish.PrinterTurnedOffEvent();
      //expect(instance).to.be.a(Flipdish.PrinterTurnedOffEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.PrinterTurnedOffEvent();
