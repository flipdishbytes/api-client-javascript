...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.UserDeletedEvent();
  });
  ...
  describe('UserDeletedEvent', function() {
    it('should create an instance of UserDeletedEvent', function() {
      ...
      //var instane = new Flipdish.UserDeletedEvent();
      //expect(instance).to.be.a(Flipdish.UserDeletedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.UserDeletedEvent();
