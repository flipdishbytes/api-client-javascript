...
(function(root, factory) {
  ...
  describe('FulfillmentStatesConfiguration', function() {
    it('should create an instance of FulfillmentStatesConfiguration', function() {
      // uncomment below and update the code to test FulfillmentStatesConfiguration
      //var instane = new Flipdish.FulfillmentStatesConfiguration();
    ...
    it('should have the property States (base name: "States")', function() {
      ...
      //var instance = new Flipdish.FulfillmentStatesConfiguration();
