...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.UpdateCatalogItem();
  });
  ...
  describe('UpdateCatalogItem', function() {
    it('should create an instance of UpdateCatalogItem', function() {
      // uncomment below and update the code to test UpdateCatalogItem
      //var instane = new Flipdish.UpdateCatalogItem();
      //expect(instance).to.be.a(Flipdish.UpdateCatalogItem);
    });

    it('should have the property Sku (base name: "Sku")', function() {
      // uncomment below and update the code to test the property Sku
      //var instance = new Flipdish.UpdateCatalogItem();
