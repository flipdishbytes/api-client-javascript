...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.BankAccountUpdatedEvent();
  });
  ...
  describe('BankAccountUpdatedEvent', function() {
    it('should create an instance of BankAccountUpdatedEvent', function() {
      // uncomment below and update the code to test BankAccountUpdatedEvent
      //var instane = new Flipdish.BankAccountUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.BankAccountUpdatedEvent);
    });
    ...
    it('should have the property BankAccount (base name: "BankAccount")', function() {
      ...
      //var instance = new Flipdish.BankAccountUpdatedEvent();
