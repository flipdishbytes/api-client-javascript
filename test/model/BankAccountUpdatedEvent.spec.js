...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.BankAccountUpdatedEvent();
  });
  ...
  describe('BankAccountUpdatedEvent', function() {
    it('should create an instance of BankAccountUpdatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.BankAccountUpdatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.BankAccountUpdatedEvent);
    });
