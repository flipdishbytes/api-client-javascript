...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreBusinessHoursOverrideDeletedEvent();
  });
  ...
  describe('StoreBusinessHoursOverrideDeletedEvent', function() {
    it('should create an instance of StoreBusinessHoursOverrideDeletedEvent', function() {
      // uncomment below and update the code to test StoreBusinessHoursOverrideDeletedEvent
      //var instane = new Flipdish.StoreBusinessHoursOverrideDeletedEvent();
      //expect(instance).to.be.a(Flipdish.StoreBusinessHoursOverrideDeletedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreBusinessHoursOverrideDeletedEvent();
