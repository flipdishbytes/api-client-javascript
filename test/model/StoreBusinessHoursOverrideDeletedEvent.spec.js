  ...
  describe('(package)', function() {
    describe('StoreBusinessHoursOverrideDeletedEvent', function() {
      ...
      it('should create an instance of StoreBusinessHoursOverrideDeletedEvent', function() {
        // TODO: update the code to test StoreBusinessHoursOverrideDeletedEvent
      ...
      it('should have the property BusinessHoursOverride (base name: "BusinessHoursOverride")', function() {
        // TODO: update the code to test the property BusinessHoursOverride
        expect(instance).to.have.property('BusinessHoursOverride');
        // expect(instance.BusinessHoursOverride).to.be(expectedValueLiteral);
      });
