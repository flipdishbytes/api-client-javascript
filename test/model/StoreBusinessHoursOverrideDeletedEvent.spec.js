...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreBusinessHoursOverrideDeletedEvent();
  });
  ...
  describe('StoreBusinessHoursOverrideDeletedEvent', function() {
    it('should create an instance of StoreBusinessHoursOverrideDeletedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StoreBusinessHoursOverrideDeletedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreBusinessHoursOverrideDeletedEvent);
    });
