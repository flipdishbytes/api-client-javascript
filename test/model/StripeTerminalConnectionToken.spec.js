...
(function(root, factory) {
  ...
  describe('StripeTerminalConnectionToken', function() {
    it('should create an instance of StripeTerminalConnectionToken', function() {
      // uncomment below and update the code to test StripeTerminalConnectionToken
      //var instane = new Flipdish.StripeTerminalConnectionToken();
      //expect(instance).to.be.a(Flipdish.StripeTerminalConnectionToken);
    });

    it('should have the property Token (base name: "Token")', function() {
      // uncomment below and update the code to test the property Token
      //var instance = new Flipdish.StripeTerminalConnectionToken();
