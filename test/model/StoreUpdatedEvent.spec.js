...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreUpdatedEvent();
  });
  ...
  describe('StoreUpdatedEvent', function() {
    it('should create an instance of StoreUpdatedEvent', function() {
      // uncomment below and update the code to test StoreUpdatedEvent
      //var instane = new Flipdish.StoreUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.StoreUpdatedEvent);
    });
