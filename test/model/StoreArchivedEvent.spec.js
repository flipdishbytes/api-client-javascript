...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreArchivedEvent();
  });
  ...
  describe('StoreArchivedEvent', function() {
    it('should create an instance of StoreArchivedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StoreArchivedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreArchivedEvent);
    });
