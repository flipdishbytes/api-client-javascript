...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreArchivedEvent();
  });
  ...
  describe('StoreArchivedEvent', function() {
    it('should create an instance of StoreArchivedEvent', function() {
      // uncomment below and update the code to test StoreArchivedEvent
      //var instane = new Flipdish.StoreArchivedEvent();
      //expect(instance).to.be.a(Flipdish.StoreArchivedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreArchivedEvent();
