...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.CreateFullMenuItemOptionSetItem();
  });
  ...
  describe('CreateFullMenuItemOptionSetItem', function() {
    it('should create an instance of CreateFullMenuItemOptionSetItem', function() {
      // uncomment below and update the code to test CreateFullMenuItemOptionSetItem
      //var instane = new Flipdish.CreateFullMenuItemOptionSetItem();
      //expect(instance).to.be.a(Flipdish.CreateFullMenuItemOptionSetItem);
    });
    ...
    it('should have the property MenuItemOptionSetItemId (base name: "MenuItemOptionSetItemId")', function() {
      ...
      //var instance = new Flipdish.CreateFullMenuItemOptionSetItem();
