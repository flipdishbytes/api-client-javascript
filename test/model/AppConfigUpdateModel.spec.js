...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.AppConfigUpdateModel();
  });
  ...
  describe('AppConfigUpdateModel', function() {
    it('should create an instance of AppConfigUpdateModel', function() {
      ...
      //var instane = new FlipdishOpenApiV10.AppConfigUpdateModel();
      //expect(instance).to.be.a(FlipdishOpenApiV10.AppConfigUpdateModel);
    });
