...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreLogoUpdatedEvent();
  });
  ...
  describe('StoreLogoUpdatedEvent', function() {
    it('should create an instance of StoreLogoUpdatedEvent', function() {
      // uncomment below and update the code to test StoreLogoUpdatedEvent
      //var instane = new Flipdish.StoreLogoUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.StoreLogoUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreLogoUpdatedEvent();
