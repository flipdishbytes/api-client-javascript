...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreOrderCapacityConfig();
  });
  ...
  describe('StoreOrderCapacityConfig', function() {
    it('should create an instance of StoreOrderCapacityConfig', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StoreOrderCapacityConfig();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreOrderCapacityConfig);
    });
