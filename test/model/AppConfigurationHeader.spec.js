...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppConfigurationHeader', function() {
      beforeEach(function() {
        instance = new Flipdish.AppConfigurationHeader();
      });

      it('should create an instance of AppConfigurationHeader', function() {
        // TODO: update the code to test AppConfigurationHeader
        expect(instance).to.be.a(Flipdish.AppConfigurationHeader);
      });
