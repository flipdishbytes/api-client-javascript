...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.WebsiteVanityUrlUpdatedEvent();
  });
  ...
  describe('WebsiteVanityUrlUpdatedEvent', function() {
    it('should create an instance of WebsiteVanityUrlUpdatedEvent', function() {
      // uncomment below and update the code to test WebsiteVanityUrlUpdatedEvent
      //var instane = new FlipdishOpenApiV10.WebsiteVanityUrlUpdatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.WebsiteVanityUrlUpdatedEvent);
    });
