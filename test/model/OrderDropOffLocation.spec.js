...
(function(root, factory) {
  ...
  describe('OrderDropOffLocation', function() {
    it('should create an instance of OrderDropOffLocation', function() {
      // uncomment below and update the code to test OrderDropOffLocation
      //var instane = new Flipdish.OrderDropOffLocation();
      //expect(instance).to.be.a(Flipdish.OrderDropOffLocation);
    });

    it('should have the property OrderId (base name: "OrderId")', function() {
      // uncomment below and update the code to test the property OrderId
      //var instance = new Flipdish.OrderDropOffLocation();
