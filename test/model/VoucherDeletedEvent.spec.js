...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.VoucherDeletedEvent();
  });
  ...
  describe('VoucherDeletedEvent', function() {
    it('should create an instance of VoucherDeletedEvent', function() {
      // uncomment below and update the code to test VoucherDeletedEvent
      //var instane = new Flipdish.VoucherDeletedEvent();
      //expect(instance).to.be.a(Flipdish.VoucherDeletedEvent);
    });
    ...
    it('should have the property VoucherId (base name: "VoucherId")', function() {
      ...
      //var instance = new Flipdish.VoucherDeletedEvent();
