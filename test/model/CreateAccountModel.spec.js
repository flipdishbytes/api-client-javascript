...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.CreateAccountModel();
  });
  ...
  describe('CreateAccountModel', function() {
    it('should create an instance of CreateAccountModel', function() {
      ...
      //var instane = new FlipdishOpenApiV10.CreateAccountModel();
      //expect(instance).to.be.a(FlipdishOpenApiV10.CreateAccountModel);
    });
