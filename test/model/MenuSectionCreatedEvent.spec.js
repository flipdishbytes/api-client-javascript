...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MenuSectionCreatedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.MenuSectionCreatedEvent();
      });

      it('should create an instance of MenuSectionCreatedEvent', function() {
        // TODO: update the code to test MenuSectionCreatedEvent
        expect(instance).to.be.a(Flipdish.MenuSectionCreatedEvent);
      });
