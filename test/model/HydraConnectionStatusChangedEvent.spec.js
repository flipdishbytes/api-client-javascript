  ...
  describe('(package)', function() {
    describe('HydraConnectionStatusChangedEvent', function() {
      ...
      it('should create an instance of HydraConnectionStatusChangedEvent', function() {
        // TODO: update the code to test HydraConnectionStatusChangedEvent
      ...
      it('should have the property HydraDeviceStatus (base name: "HydraDeviceStatus")', function() {
        // TODO: update the code to test the property HydraDeviceStatus
        expect(instance).to.have.property('HydraDeviceStatus');
        // expect(instance.HydraDeviceStatus).to.be(expectedValueLiteral);
      });

      it('should have the property PollTime (base name: "PollTime")', function() {
        // TODO: update the code to test the property PollTime
        expect(instance).to.have.property('PollTime');
        // expect(instance.PollTime).to.be(expectedValueLiteral);
      });
