...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.RetentionCampaign();
  });
  ...
  describe('RetentionCampaign', function() {
    it('should create an instance of RetentionCampaign', function() {
      // uncomment below and update the code to test RetentionCampaign
      //var instane = new FlipdishOpenApiV10.RetentionCampaign();
      //expect(instance).to.be.a(FlipdishOpenApiV10.RetentionCampaign);
    });
