...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('OrderCreatedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.OrderCreatedEvent();
      });

      it('should create an instance of OrderCreatedEvent', function() {
        // TODO: update the code to test OrderCreatedEvent
        expect(instance).to.be.a(Flipdish.OrderCreatedEvent);
      });
      ...
      it('should have the property OrderCreatedTime (base name: "OrderCreatedTime")', function() {
        // TODO: update the code to test the property OrderCreatedTime
        expect(instance).to.have.property('OrderCreatedTime');
        // expect(instance.OrderCreatedTime).to.be(expectedValueLiteral);
      });
