...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.LocalisedTimeZone();
  });
  ...
  describe('LocalisedTimeZone', function() {
    it('should create an instance of LocalisedTimeZone', function() {
      ...
      //var instane = new FlipdishOpenApiV10.LocalisedTimeZone();
      //expect(instance).to.be.a(FlipdishOpenApiV10.LocalisedTimeZone);
    });
