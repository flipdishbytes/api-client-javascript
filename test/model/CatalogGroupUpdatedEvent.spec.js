...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.CatalogGroupUpdatedEvent();
  });
  ...
  describe('CatalogGroupUpdatedEvent', function() {
    it('should create an instance of CatalogGroupUpdatedEvent', function() {
      // uncomment below and update the code to test CatalogGroupUpdatedEvent
      //var instane = new Flipdish.CatalogGroupUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.CatalogGroupUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.CatalogGroupUpdatedEvent();
