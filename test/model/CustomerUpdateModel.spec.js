...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.CustomerUpdateModel();
  });
  ...
  describe('CustomerUpdateModel', function() {
    it('should create an instance of CustomerUpdateModel', function() {
      ...
      //var instane = new FlipdishOpenApiV10.CustomerUpdateModel();
      //expect(instance).to.be.a(FlipdishOpenApiV10.CustomerUpdateModel);
    });
