...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppStoreSubscriptionChangeJobStatusResponse', function() {
      beforeEach(function() {
        instance = new Flipdish.AppStoreSubscriptionChangeJobStatusResponse();
      });

      it('should create an instance of AppStoreSubscriptionChangeJobStatusResponse', function() {
        // TODO: update the code to test AppStoreSubscriptionChangeJobStatusResponse
        expect(instance).to.be.a(Flipdish.AppStoreSubscriptionChangeJobStatusResponse);
      });
