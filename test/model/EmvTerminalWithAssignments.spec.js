...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.EmvTerminalWithAssignments();
  });
  ...
  describe('EmvTerminalWithAssignments', function() {
    it('should create an instance of EmvTerminalWithAssignments', function() {
      ...
      //var instane = new FlipdishOpenApiV10.EmvTerminalWithAssignments();
      //expect(instance).to.be.a(FlipdishOpenApiV10.EmvTerminalWithAssignments);
    });
