...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreCollectionSettings();
  });
  ...
  describe('StoreCollectionSettings', function() {
    it('should create an instance of StoreCollectionSettings', function() {
      // uncomment below and update the code to test StoreCollectionSettings
      //var instane = new Flipdish.StoreCollectionSettings();
      //expect(instance).to.be.a(Flipdish.StoreCollectionSettings);
    });
    ...
    it('should have the property PickupEnabled (base name: "PickupEnabled")', function() {
      ...
      //var instance = new Flipdish.StoreCollectionSettings();
