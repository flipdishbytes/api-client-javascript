...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.BankAccountDetailsUpdateRequest();
  });
  ...
  describe('BankAccountDetailsUpdateRequest', function() {
    it('should create an instance of BankAccountDetailsUpdateRequest', function() {
      // uncomment below and update the code to test BankAccountDetailsUpdateRequest
      //var instane = new FlipdishOpenApiV10.BankAccountDetailsUpdateRequest();
      //expect(instance).to.be.a(FlipdishOpenApiV10.BankAccountDetailsUpdateRequest);
    });
