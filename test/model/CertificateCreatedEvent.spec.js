...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.CertificateCreatedEvent();
  });
  ...
  describe('CertificateCreatedEvent', function() {
    it('should create an instance of CertificateCreatedEvent', function() {
      // uncomment below and update the code to test CertificateCreatedEvent
      //var instane = new Flipdish.CertificateCreatedEvent();
      //expect(instance).to.be.a(Flipdish.CertificateCreatedEvent);
    });

    it('should have the property Hostname (base name: "Hostname")', function() {
      // uncomment below and update the code to test the property Hostname
      //var instance = new Flipdish.CertificateCreatedEvent();
