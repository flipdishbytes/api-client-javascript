...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.CertificateCreatedEvent();
  });
  ...
  describe('CertificateCreatedEvent', function() {
    it('should create an instance of CertificateCreatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.CertificateCreatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.CertificateCreatedEvent);
    });
