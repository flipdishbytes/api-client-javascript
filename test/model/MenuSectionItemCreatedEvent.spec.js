...
(function(root, factory) {
  ...
  describe('MenuSectionItemCreatedEvent', function() {
    it('should create an instance of MenuSectionItemCreatedEvent', function() {
      // uncomment below and update the code to test MenuSectionItemCreatedEvent
      //var instane = new Flipdish.MenuSectionItemCreatedEvent();
    ...
    it('should have the property MenuId (base name: "MenuId")', function() {
      ...
      //var instance = new Flipdish.MenuSectionItemCreatedEvent();
