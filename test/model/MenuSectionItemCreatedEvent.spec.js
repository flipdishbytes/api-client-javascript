...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MenuSectionItemCreatedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.MenuSectionItemCreatedEvent();
      });

      it('should create an instance of MenuSectionItemCreatedEvent', function() {
        // TODO: update the code to test MenuSectionItemCreatedEvent
        expect(instance).to.be.a(Flipdish.MenuSectionItemCreatedEvent);
      });
      ...
      it('should have the property MenuSectionItem (base name: "MenuSectionItem")', function() {
        // TODO: update the code to test the property MenuSectionItem
        expect(instance).to.have.property('MenuSectionItem');
        // expect(instance.MenuSectionItem).to.be(expectedValueLiteral);
      });
