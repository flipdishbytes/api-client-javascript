...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.TeammateInviteAcceptedEvent();
  });
  ...
  describe('TeammateInviteAcceptedEvent', function() {
    it('should create an instance of TeammateInviteAcceptedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.TeammateInviteAcceptedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.TeammateInviteAcceptedEvent);
    });
