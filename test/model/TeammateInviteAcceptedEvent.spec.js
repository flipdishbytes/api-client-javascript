...
(function(root, factory) {
  ...
  describe('TeammateInviteAcceptedEvent', function() {
    it('should create an instance of TeammateInviteAcceptedEvent', function() {
      // uncomment below and update the code to test TeammateInviteAcceptedEvent
      //var instane = new Flipdish.TeammateInviteAcceptedEvent();
    ...
    it('should have the property Teammate (base name: "Teammate")', function() {
      ...
      //var instance = new Flipdish.TeammateInviteAcceptedEvent();
