...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeammateInviteAcceptedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.TeammateInviteAcceptedEvent();
      });

      it('should create an instance of TeammateInviteAcceptedEvent', function() {
        // TODO: update the code to test TeammateInviteAcceptedEvent
        expect(instance).to.be.a(Flipdish.TeammateInviteAcceptedEvent);
      });
