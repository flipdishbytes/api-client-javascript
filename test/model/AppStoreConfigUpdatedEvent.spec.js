...
(function(root, factory) {
  ...
  describe('AppStoreConfigUpdatedEvent', function() {
    it('should create an instance of AppStoreConfigUpdatedEvent', function() {
      // uncomment below and update the code to test AppStoreConfigUpdatedEvent
      //var instane = new Flipdish.AppStoreConfigUpdatedEvent();
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.AppStoreConfigUpdatedEvent();
    ...
    it('should have the property AppStoreAppConfiguration (base name: "AppStoreAppConfiguration")', function() {
      // uncomment below and update the code to test the property AppStoreAppConfiguration
      //var instance = new Flipdish.AppStoreConfigUpdatedEvent();
      //expect(instance).to.be();
    });
