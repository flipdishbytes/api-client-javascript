...
(function(root, factory) {
  ...
  describe('TeammateUpdatedEvent', function() {
    it('should create an instance of TeammateUpdatedEvent', function() {
      // uncomment below and update the code to test TeammateUpdatedEvent
      //var instane = new Flipdish.TeammateUpdatedEvent();
    ...
    it('should have the property Teammate (base name: "Teammate")', function() {
      ...
      //var instance = new Flipdish.TeammateUpdatedEvent();
