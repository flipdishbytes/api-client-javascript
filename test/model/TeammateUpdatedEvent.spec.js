...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeammateUpdatedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.TeammateUpdatedEvent();
      });

      it('should create an instance of TeammateUpdatedEvent', function() {
        // TODO: update the code to test TeammateUpdatedEvent
        expect(instance).to.be.a(Flipdish.TeammateUpdatedEvent);
      });
