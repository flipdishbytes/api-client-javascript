...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.TeammateUpdatedEvent();
  });
  ...
  describe('TeammateUpdatedEvent', function() {
    it('should create an instance of TeammateUpdatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.TeammateUpdatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.TeammateUpdatedEvent);
    });
