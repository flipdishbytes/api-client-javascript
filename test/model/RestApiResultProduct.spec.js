...
(function(root, factory) {
  ...
  describe('RestApiResultProduct', function() {
    it('should create an instance of RestApiResultProduct', function() {
      // uncomment below and update the code to test RestApiResultProduct
      //var instane = new Flipdish.RestApiResultProduct();
      //expect(instance).to.be.a(Flipdish.RestApiResultProduct);
    });

    it('should have the property Data (base name: "Data")', function() {
      // uncomment below and update the code to test the property Data
      //var instance = new Flipdish.RestApiResultProduct();
