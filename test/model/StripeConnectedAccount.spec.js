...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StripeConnectedAccount();
  });
  ...
  describe('StripeConnectedAccount', function() {
    it('should create an instance of StripeConnectedAccount', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StripeConnectedAccount();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StripeConnectedAccount);
    });
