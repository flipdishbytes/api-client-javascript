...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.CreateFullMenu();
  });
  ...
  describe('CreateFullMenu', function() {
    it('should create an instance of CreateFullMenu', function() {
      ...
      //var instane = new FlipdishOpenApiV10.CreateFullMenu();
      //expect(instance).to.be.a(FlipdishOpenApiV10.CreateFullMenu);
    });
