...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.ProcessingFeeConfig();
  });
  ...
  describe('ProcessingFeeConfig', function() {
    it('should create an instance of ProcessingFeeConfig', function() {
      // uncomment below and update the code to test ProcessingFeeConfig
      //var instane = new FlipdishOpenApiV10.ProcessingFeeConfig();
      //expect(instance).to.be.a(FlipdishOpenApiV10.ProcessingFeeConfig);
    });
    ...
    it('should have the property fixedFee (base name: "FixedFee")', function() {
      // uncomment below and update the code to test the property fixedFee
      //var instane = new FlipdishOpenApiV10.ProcessingFeeConfig();
      //expect(instance).to.be();
    });
