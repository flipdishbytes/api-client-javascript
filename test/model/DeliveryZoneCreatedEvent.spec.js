...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.DeliveryZoneCreatedEvent();
  });
  ...
  describe('DeliveryZoneCreatedEvent', function() {
    it('should create an instance of DeliveryZoneCreatedEvent', function() {
      // uncomment below and update the code to test DeliveryZoneCreatedEvent
      //var instane = new Flipdish.DeliveryZoneCreatedEvent();
      //expect(instance).to.be.a(Flipdish.DeliveryZoneCreatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.DeliveryZoneCreatedEvent();
    ...
    it('should have the property DeliveryZone (base name: "DeliveryZone")', function() {
      // uncomment below and update the code to test the property DeliveryZone
      //var instance = new Flipdish.DeliveryZoneCreatedEvent();
      //expect(instance).to.be();
    });
