...
(function(root, factory) {
  ...
  describe('RestApiResultPaymentIntent', function() {
    it('should create an instance of RestApiResultPaymentIntent', function() {
      // uncomment below and update the code to test RestApiResultPaymentIntent
      //var instane = new Flipdish.RestApiResultPaymentIntent();
      //expect(instance).to.be.a(Flipdish.RestApiResultPaymentIntent);
    });

    it('should have the property Data (base name: "Data")', function() {
      // uncomment below and update the code to test the property Data
      //var instance = new Flipdish.RestApiResultPaymentIntent();
