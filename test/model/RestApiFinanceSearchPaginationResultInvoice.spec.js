...
(function(root, factory) {
  ...
  describe('RestApiFinanceSearchPaginationResultInvoice', function() {
    it('should create an instance of RestApiFinanceSearchPaginationResultInvoice', function() {
      // uncomment below and update the code to test RestApiFinanceSearchPaginationResultInvoice
      //var instane = new Flipdish.RestApiFinanceSearchPaginationResultInvoice();
    ...
    it('should have the property NextPage (base name: "NextPage")', function() {
      ...
      //var instance = new Flipdish.RestApiFinanceSearchPaginationResultInvoice();
