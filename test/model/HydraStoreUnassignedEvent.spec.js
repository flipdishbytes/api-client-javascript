...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.HydraStoreUnassignedEvent();
  });
  ...
  describe('HydraStoreUnassignedEvent', function() {
    it('should create an instance of HydraStoreUnassignedEvent', function() {
      // uncomment below and update the code to test HydraStoreUnassignedEvent
      //var instane = new Flipdish.HydraStoreUnassignedEvent();
      //expect(instance).to.be.a(Flipdish.HydraStoreUnassignedEvent);
    });

    it('should have the property User (base name: "User")', function() {
      // uncomment below and update the code to test the property User
      //var instance = new Flipdish.HydraStoreUnassignedEvent();
