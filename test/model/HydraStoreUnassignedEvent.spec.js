...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.HydraStoreUnassignedEvent();
  });
  ...
  describe('HydraStoreUnassignedEvent', function() {
    it('should create an instance of HydraStoreUnassignedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.HydraStoreUnassignedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.HydraStoreUnassignedEvent);
    });
