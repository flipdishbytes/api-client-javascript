...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.HydraStoreAssignedEvent();
  });
  ...
  describe('HydraStoreAssignedEvent', function() {
    it('should create an instance of HydraStoreAssignedEvent', function() {
      // uncomment below and update the code to test HydraStoreAssignedEvent
      //var instane = new Flipdish.HydraStoreAssignedEvent();
      //expect(instance).to.be.a(Flipdish.HydraStoreAssignedEvent);
    });

    it('should have the property User (base name: "User")', function() {
      // uncomment below and update the code to test the property User
      //var instance = new Flipdish.HydraStoreAssignedEvent();
