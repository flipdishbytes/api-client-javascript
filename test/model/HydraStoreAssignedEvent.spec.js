...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.HydraStoreAssignedEvent();
  });
  ...
  describe('HydraStoreAssignedEvent', function() {
    it('should create an instance of HydraStoreAssignedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.HydraStoreAssignedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.HydraStoreAssignedEvent);
    });
