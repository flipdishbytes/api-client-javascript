...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreOrderCapacityPeriod();
  });
  ...
  describe('StoreOrderCapacityPeriod', function() {
    it('should create an instance of StoreOrderCapacityPeriod', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StoreOrderCapacityPeriod();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreOrderCapacityPeriod);
    });
