...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('AppDetail', function() {
      beforeEach(function() {
        instance = new Flipdish.AppDetail();
      });

      it('should create an instance of AppDetail', function() {
        // TODO: update the code to test AppDetail
        expect(instance).to.be.a(Flipdish.AppDetail);
      });
