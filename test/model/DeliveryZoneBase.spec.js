...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.DeliveryZoneBase();
  });
  ...
  describe('DeliveryZoneBase', function() {
    it('should create an instance of DeliveryZoneBase', function() {
      // uncomment below and update the code to test DeliveryZoneBase
      //var instane = new FlipdishOpenApiV10.DeliveryZoneBase();
      //expect(instance).to.be.a(FlipdishOpenApiV10.DeliveryZoneBase);
    });
