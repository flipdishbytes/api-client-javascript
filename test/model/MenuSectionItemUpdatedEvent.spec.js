...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('MenuSectionItemUpdatedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.MenuSectionItemUpdatedEvent();
      });

      it('should create an instance of MenuSectionItemUpdatedEvent', function() {
        // TODO: update the code to test MenuSectionItemUpdatedEvent
        expect(instance).to.be.a(Flipdish.MenuSectionItemUpdatedEvent);
      });
