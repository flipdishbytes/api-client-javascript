...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreFeeConfigUpdatedEvent();
  });
  ...
  describe('StoreFeeConfigUpdatedEvent', function() {
    it('should create an instance of StoreFeeConfigUpdatedEvent', function() {
      // uncomment below and update the code to test StoreFeeConfigUpdatedEvent
      //var instane = new Flipdish.StoreFeeConfigUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.StoreFeeConfigUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreFeeConfigUpdatedEvent();
    ...
    it('should have the property StoreFeeConfig (base name: "StoreFeeConfig")', function() {
      // uncomment below and update the code to test the property StoreFeeConfig
      //var instance = new Flipdish.StoreFeeConfigUpdatedEvent();
      //expect(instance).to.be();
    });
