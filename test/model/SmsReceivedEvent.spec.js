  ...
  describe('(package)', function() {
    describe('SmsReceivedEvent', function() {
      ...
      it('should create an instance of SmsReceivedEvent', function() {
        // TODO: update the code to test SmsReceivedEvent
      ...
      it('should have the property SmsInfo (base name: "SmsInfo")', function() {
        // TODO: update the code to test the property SmsInfo
        expect(instance).to.have.property('SmsInfo');
        // expect(instance.SmsInfo).to.be(expectedValueLiteral);
      });
