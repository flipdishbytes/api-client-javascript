  ...
  describe('(package)', function() {
    describe('HydraSettingChangedEvent', function() {
      ...
      it('should create an instance of HydraSettingChangedEvent', function() {
        // TODO: update the code to test HydraSettingChangedEvent
      ...
      it('should have the property HydraConfig (base name: "HydraConfig")', function() {
        // TODO: update the code to test the property HydraConfig
        expect(instance).to.have.property('HydraConfig');
        // expect(instance.HydraConfig).to.be(expectedValueLiteral);
      });
