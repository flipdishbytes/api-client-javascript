...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StorePublishedEvent();
  });
  ...
  describe('StorePublishedEvent', function() {
    it('should create an instance of StorePublishedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StorePublishedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StorePublishedEvent);
    });
