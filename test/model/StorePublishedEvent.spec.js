...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StorePublishedEvent();
  });
  ...
  describe('StorePublishedEvent', function() {
    it('should create an instance of StorePublishedEvent', function() {
      // uncomment below and update the code to test StorePublishedEvent
      //var instane = new Flipdish.StorePublishedEvent();
      //expect(instance).to.be.a(Flipdish.StorePublishedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StorePublishedEvent();
