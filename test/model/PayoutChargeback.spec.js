  ...
  describe('(package)', function() {
    describe('PayoutChargeback', function() {
      ...
      it('should create an instance of PayoutChargeback', function() {
        // TODO: update the code to test PayoutChargeback
      ...
      it('should have the property ChargebackDate (base name: "ChargebackDate")', function() {
        // TODO: update the code to test the property ChargebackDate
        expect(instance).to.have.property('ChargebackDate');
        // expect(instance.ChargebackDate).to.be(expectedValueLiteral);
      });
