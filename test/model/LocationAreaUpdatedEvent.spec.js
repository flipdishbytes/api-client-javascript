...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.LocationAreaUpdatedEvent();
  });
  ...
  describe('LocationAreaUpdatedEvent', function() {
    it('should create an instance of LocationAreaUpdatedEvent', function() {
      // uncomment below and update the code to test LocationAreaUpdatedEvent
      //var instane = new Flipdish.LocationAreaUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.LocationAreaUpdatedEvent);
    });
    ...
    it('should have the property LocationAreaId (base name: "LocationAreaId")', function() {
      ...
      //var instance = new Flipdish.LocationAreaUpdatedEvent();
