  ...
  describe('(package)', function() {
    describe('StoreKioskSetting', function() {
      ...
      it('should have the property RequestCustomerPhoneNumber (base name: "RequestCustomerPhoneNumber")', function() {
        // TODO: update the code to test the property RequestCustomerPhoneNumber
        expect(instance).to.have.property('RequestCustomerPhoneNumber');
        // expect(instance.RequestCustomerPhoneNumber).to.be(expectedValueLiteral);
      });
