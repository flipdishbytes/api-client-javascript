...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.UserPasswordCreatedEvent();
  });
  ...
  describe('UserPasswordCreatedEvent', function() {
    it('should create an instance of UserPasswordCreatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.UserPasswordCreatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.UserPasswordCreatedEvent);
    });
