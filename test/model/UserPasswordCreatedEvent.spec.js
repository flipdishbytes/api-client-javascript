...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.UserPasswordCreatedEvent();
  });
  ...
  describe('UserPasswordCreatedEvent', function() {
    it('should create an instance of UserPasswordCreatedEvent', function() {
      // uncomment below and update the code to test UserPasswordCreatedEvent
      //var instane = new Flipdish.UserPasswordCreatedEvent();
      //expect(instance).to.be.a(Flipdish.UserPasswordCreatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.UserPasswordCreatedEvent();
