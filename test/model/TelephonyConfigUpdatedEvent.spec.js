...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TelephonyConfigUpdatedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.TelephonyConfigUpdatedEvent();
      });

      it('should create an instance of TelephonyConfigUpdatedEvent', function() {
        // TODO: update the code to test TelephonyConfigUpdatedEvent
        expect(instance).to.be.a(Flipdish.TelephonyConfigUpdatedEvent);
      });
      ...
      it('should have the property TelephonyConfig (base name: "TelephonyConfig")', function() {
        // TODO: update the code to test the property TelephonyConfig
        expect(instance).to.have.property('TelephonyConfig');
        // expect(instance.TelephonyConfig).to.be(expectedValueLiteral);
      });
