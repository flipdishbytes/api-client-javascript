  ...
  describe('(package)', function() {
    describe('OrderDispatchedEvent', function() {
      ...
      it('should create an instance of OrderDispatchedEvent', function() {
        // TODO: update the code to test OrderDispatchedEvent
      ...
      it('should have the property OrderDispatchedTime (base name: "OrderDispatchedTime")', function() {
        // TODO: update the code to test the property OrderDispatchedTime
        expect(instance).to.have.property('OrderDispatchedTime');
        // expect(instance.OrderDispatchedTime).to.be(expectedValueLiteral);
      });
