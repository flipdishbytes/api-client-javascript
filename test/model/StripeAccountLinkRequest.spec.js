...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StripeAccountLinkRequest();
  });
  ...
  describe('StripeAccountLinkRequest', function() {
    it('should create an instance of StripeAccountLinkRequest', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StripeAccountLinkRequest();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StripeAccountLinkRequest);
    });
