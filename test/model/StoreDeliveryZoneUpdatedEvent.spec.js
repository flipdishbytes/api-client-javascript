...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreDeliveryZoneUpdatedEvent();
  });
  ...
  describe('StoreDeliveryZoneUpdatedEvent', function() {
    it('should create an instance of StoreDeliveryZoneUpdatedEvent', function() {
      // uncomment below and update the code to test StoreDeliveryZoneUpdatedEvent
      //var instane = new Flipdish.StoreDeliveryZoneUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.StoreDeliveryZoneUpdatedEvent);
    });
