...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('KioskBluetoothTerminalInstallationStatusEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.KioskBluetoothTerminalInstallationStatusEvent();
      });

      it('should create an instance of KioskBluetoothTerminalInstallationStatusEvent', function() {
        // TODO: update the code to test KioskBluetoothTerminalInstallationStatusEvent
        expect(instance).to.be.a(Flipdish.KioskBluetoothTerminalInstallationStatusEvent);
      });
