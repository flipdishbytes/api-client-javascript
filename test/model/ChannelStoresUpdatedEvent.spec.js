...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.ChannelStoresUpdatedEvent();
  });
  ...
  describe('ChannelStoresUpdatedEvent', function() {
    it('should create an instance of ChannelStoresUpdatedEvent', function() {
      // uncomment below and update the code to test ChannelStoresUpdatedEvent
      //var instane = new Flipdish.ChannelStoresUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.ChannelStoresUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.ChannelStoresUpdatedEvent();
