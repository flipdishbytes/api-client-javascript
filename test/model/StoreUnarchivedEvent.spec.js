...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreUnarchivedEvent();
  });
  ...
  describe('StoreUnarchivedEvent', function() {
    it('should create an instance of StoreUnarchivedEvent', function() {
      // uncomment below and update the code to test StoreUnarchivedEvent
      //var instane = new Flipdish.StoreUnarchivedEvent();
      //expect(instance).to.be.a(Flipdish.StoreUnarchivedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreUnarchivedEvent();
