...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreLogoCreatedEvent();
  });
  ...
  describe('StoreLogoCreatedEvent', function() {
    it('should create an instance of StoreLogoCreatedEvent', function() {
      // uncomment below and update the code to test StoreLogoCreatedEvent
      //var instane = new FlipdishOpenApiV10.StoreLogoCreatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreLogoCreatedEvent);
    });
