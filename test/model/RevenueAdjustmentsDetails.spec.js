...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.RevenueAdjustmentsDetails();
  });
  ...
  describe('RevenueAdjustmentsDetails', function() {
    it('should create an instance of RevenueAdjustmentsDetails', function() {
      ...
      //var instane = new FlipdishOpenApiV10.RevenueAdjustmentsDetails();
      //expect(instance).to.be.a(FlipdishOpenApiV10.RevenueAdjustmentsDetails);
    });
