...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.ClientDevice();
  });
  ...
  describe('ClientDevice', function() {
    it('should create an instance of ClientDevice', function() {
      // uncomment below and update the code to test ClientDevice
      //var instane = new Flipdish.ClientDevice();
      //expect(instance).to.be.a(Flipdish.ClientDevice);
    });
    ...
    it('should have the property DeviceModel (base name: "DeviceModel")', function() {
      ...
      //var instance = new Flipdish.ClientDevice();
