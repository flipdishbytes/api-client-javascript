...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('RestApiPaginationResultAppSummary', function() {
      beforeEach(function() {
        instance = new Flipdish.RestApiPaginationResultAppSummary();
      });

      it('should create an instance of RestApiPaginationResultAppSummary', function() {
        // TODO: update the code to test RestApiPaginationResultAppSummary
        expect(instance).to.be.a(Flipdish.RestApiPaginationResultAppSummary);
      });
