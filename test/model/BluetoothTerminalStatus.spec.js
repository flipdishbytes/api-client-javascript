...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.BluetoothTerminalStatus();
  });
  ...
  describe('BluetoothTerminalStatus', function() {
    it('should create an instance of BluetoothTerminalStatus', function() {
      // uncomment below and update the code to test BluetoothTerminalStatus
      //var instane = new FlipdishOpenApiV10.BluetoothTerminalStatus();
      //expect(instance).to.be.a(FlipdishOpenApiV10.BluetoothTerminalStatus);
    });
