...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreDeletedEvent();
  });
  ...
  describe('StoreDeletedEvent', function() {
    it('should create an instance of StoreDeletedEvent', function() {
      // uncomment below and update the code to test StoreDeletedEvent
      //var instane = new Flipdish.StoreDeletedEvent();
      //expect(instance).to.be.a(Flipdish.StoreDeletedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreDeletedEvent();
