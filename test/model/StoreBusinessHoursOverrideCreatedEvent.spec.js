...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreBusinessHoursOverrideCreatedEvent();
  });
  ...
  describe('StoreBusinessHoursOverrideCreatedEvent', function() {
    it('should create an instance of StoreBusinessHoursOverrideCreatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StoreBusinessHoursOverrideCreatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreBusinessHoursOverrideCreatedEvent);
    });
