...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.CustomerUpdatedEvent();
  });
  ...
  describe('CustomerUpdatedEvent', function() {
    it('should create an instance of CustomerUpdatedEvent', function() {
      // uncomment below and update the code to test CustomerUpdatedEvent
      //var instane = new Flipdish.CustomerUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.CustomerUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.CustomerUpdatedEvent();
