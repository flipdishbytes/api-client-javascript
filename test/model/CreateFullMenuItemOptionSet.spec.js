...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.CreateFullMenuItemOptionSet();
  });
  ...
  describe('CreateFullMenuItemOptionSet', function() {
    it('should create an instance of CreateFullMenuItemOptionSet', function() {
      // uncomment below and update the code to test CreateFullMenuItemOptionSet
      //var instane = new FlipdishOpenApiV10.CreateFullMenuItemOptionSet();
      //expect(instance).to.be.a(FlipdishOpenApiV10.CreateFullMenuItemOptionSet);
    });
