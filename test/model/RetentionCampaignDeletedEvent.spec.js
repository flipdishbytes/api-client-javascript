...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.RetentionCampaignDeletedEvent();
  });
  ...
  describe('RetentionCampaignDeletedEvent', function() {
    it('should create an instance of RetentionCampaignDeletedEvent', function() {
      // uncomment below and update the code to test RetentionCampaignDeletedEvent
      //var instane = new Flipdish.RetentionCampaignDeletedEvent();
      //expect(instance).to.be.a(Flipdish.RetentionCampaignDeletedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.RetentionCampaignDeletedEvent();
