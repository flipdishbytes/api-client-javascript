  ...
  describe('(package)', function() {
    describe('RetentionCampaignDeletedEvent', function() {
      ...
      it('should create an instance of RetentionCampaignDeletedEvent', function() {
        // TODO: update the code to test RetentionCampaignDeletedEvent
      ...
      it('should have the property RetentionCampaign (base name: "RetentionCampaign")', function() {
        // TODO: update the code to test the property RetentionCampaign
        expect(instance).to.have.property('RetentionCampaign');
        // expect(instance.RetentionCampaign).to.be(expectedValueLiteral);
      });
