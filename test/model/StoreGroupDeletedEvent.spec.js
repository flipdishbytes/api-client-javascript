...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreGroupDeletedEvent();
  });
  ...
  describe('StoreGroupDeletedEvent', function() {
    it('should create an instance of StoreGroupDeletedEvent', function() {
      // uncomment below and update the code to test StoreGroupDeletedEvent
      //var instane = new Flipdish.StoreGroupDeletedEvent();
      //expect(instance).to.be.a(Flipdish.StoreGroupDeletedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreGroupDeletedEvent();
