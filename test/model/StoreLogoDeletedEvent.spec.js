...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreLogoDeletedEvent();
  });
  ...
  describe('StoreLogoDeletedEvent', function() {
    it('should create an instance of StoreLogoDeletedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StoreLogoDeletedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreLogoDeletedEvent);
    });
