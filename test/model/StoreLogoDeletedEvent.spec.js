...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.StoreLogoDeletedEvent();
  });
  ...
  describe('StoreLogoDeletedEvent', function() {
    it('should create an instance of StoreLogoDeletedEvent', function() {
      // uncomment below and update the code to test StoreLogoDeletedEvent
      //var instane = new Flipdish.StoreLogoDeletedEvent();
      //expect(instance).to.be.a(Flipdish.StoreLogoDeletedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.StoreLogoDeletedEvent();
