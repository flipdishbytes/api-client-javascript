...
(function(root, factory) {
  ...
  describe('RestApiResultTipConfiguration', function() {
    it('should create an instance of RestApiResultTipConfiguration', function() {
      // uncomment below and update the code to test RestApiResultTipConfiguration
      //var instane = new Flipdish.RestApiResultTipConfiguration();
      //expect(instance).to.be.a(Flipdish.RestApiResultTipConfiguration);
    });

    it('should have the property Data (base name: "Data")', function() {
      // uncomment below and update the code to test the property Data
      //var instance = new Flipdish.RestApiResultTipConfiguration();
