...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.PrinterTurnedOnEvent();
  });
  ...
  describe('PrinterTurnedOnEvent', function() {
    it('should create an instance of PrinterTurnedOnEvent', function() {
      // uncomment below and update the code to test PrinterTurnedOnEvent
      //var instane = new Flipdish.PrinterTurnedOnEvent();
      //expect(instance).to.be.a(Flipdish.PrinterTurnedOnEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.PrinterTurnedOnEvent();
