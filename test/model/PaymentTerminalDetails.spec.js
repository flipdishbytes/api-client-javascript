...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.PaymentTerminalDetails();
  });
  ...
  describe('PaymentTerminalDetails', function() {
    it('should create an instance of PaymentTerminalDetails', function() {
      ...
      //var instane = new FlipdishOpenApiV10.PaymentTerminalDetails();
      //expect(instance).to.be.a(FlipdishOpenApiV10.PaymentTerminalDetails);
    });
