...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.HydraStoreData();
  });
  ...
  describe('HydraStoreData', function() {
    it('should create an instance of HydraStoreData', function() {
      ...
      //var instane = new FlipdishOpenApiV10.HydraStoreData();
      //expect(instance).to.be.a(FlipdishOpenApiV10.HydraStoreData);
    });
