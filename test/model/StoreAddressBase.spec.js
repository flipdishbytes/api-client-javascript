...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StoreAddressBase();
  });
  ...
  describe('StoreAddressBase', function() {
    it('should create an instance of StoreAddressBase', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StoreAddressBase();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StoreAddressBase);
    });
