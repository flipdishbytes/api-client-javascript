...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.DeliveryZoneDeletedEvent();
  });
  ...
  describe('DeliveryZoneDeletedEvent', function() {
    it('should create an instance of DeliveryZoneDeletedEvent', function() {
      // uncomment below and update the code to test DeliveryZoneDeletedEvent
      //var instane = new FlipdishOpenApiV10.DeliveryZoneDeletedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.DeliveryZoneDeletedEvent);
    });
