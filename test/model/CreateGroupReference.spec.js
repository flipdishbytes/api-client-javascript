...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.CreateGroupReference();
  });
  ...
  describe('CreateGroupReference', function() {
    it('should create an instance of CreateGroupReference', function() {
      // uncomment below and update the code to test CreateGroupReference
      //var instane = new Flipdish.CreateGroupReference();
    ...
    it('should have the property CatalogItemId (base name: "CatalogItemId")', function() {
      ...
      //var instance = new Flipdish.CreateGroupReference();
