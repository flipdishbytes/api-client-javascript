...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.OrderDeliveryTrackingStatusUpdatedEvent();
  });
  ...
  describe('OrderDeliveryTrackingStatusUpdatedEvent', function() {
    it('should create an instance of OrderDeliveryTrackingStatusUpdatedEvent', function() {
      // uncomment below and update the code to test OrderDeliveryTrackingStatusUpdatedEvent
      //var instane = new Flipdish.OrderDeliveryTrackingStatusUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.OrderDeliveryTrackingStatusUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.OrderDeliveryTrackingStatusUpdatedEvent();
    ...
    it('should have the property DeliveryIntegrationName (base name: "DeliveryIntegrationName")', function() {
      // uncomment below and update the code to test the property DeliveryIntegrationName
      //var instance = new Flipdish.OrderDeliveryTrackingStatusUpdatedEvent();
      //expect(instance).to.be();
    });

    it('should have the property DeliveryErrorMessage (base name: "DeliveryErrorMessage")', function() {
      // uncomment below and update the code to test the property DeliveryErrorMessage
      //var instance = new Flipdish.OrderDeliveryTrackingStatusUpdatedEvent();
      //expect(instance).to.be();
    });
