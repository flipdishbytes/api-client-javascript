...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.StuartSettingsTransportPrices();
  });
  ...
  describe('StuartSettingsTransportPrices', function() {
    it('should create an instance of StuartSettingsTransportPrices', function() {
      ...
      //var instane = new FlipdishOpenApiV10.StuartSettingsTransportPrices();
      //expect(instance).to.be.a(FlipdishOpenApiV10.StuartSettingsTransportPrices);
    });
