...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.AppUpdatedEvent();
  });
  ...
  describe('AppUpdatedEvent', function() {
    it('should create an instance of AppUpdatedEvent', function() {
      ...
      //var instane = new Flipdish.AppUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.AppUpdatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.AppUpdatedEvent();
