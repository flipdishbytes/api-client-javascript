...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.ChargebackDetails();
  });
  ...
  describe('ChargebackDetails', function() {
    it('should create an instance of ChargebackDetails', function() {
      ...
      //var instane = new FlipdishOpenApiV10.ChargebackDetails();
      //expect(instance).to.be.a(FlipdishOpenApiV10.ChargebackDetails);
    });
