...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('PushNotificationScheduledEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.PushNotificationScheduledEvent();
      });

      it('should create an instance of PushNotificationScheduledEvent', function() {
        // TODO: update the code to test PushNotificationScheduledEvent
        expect(instance).to.be.a(Flipdish.PushNotificationScheduledEvent);
      });
      ...
      it('should have the property PushNotification (base name: "PushNotification")', function() {
        // TODO: update the code to test the property PushNotification
        expect(instance).to.have.property('PushNotification');
        // expect(instance.PushNotification).to.be(expectedValueLiteral);
      });
