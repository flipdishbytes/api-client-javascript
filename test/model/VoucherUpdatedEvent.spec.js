...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.VoucherUpdatedEvent();
  });
  ...
  describe('VoucherUpdatedEvent', function() {
    it('should create an instance of VoucherUpdatedEvent', function() {
      // uncomment below and update the code to test VoucherUpdatedEvent
      //var instane = new Flipdish.VoucherUpdatedEvent();
      //expect(instance).to.be.a(Flipdish.VoucherUpdatedEvent);
    });
    ...
    it('should have the property VoucherId (base name: "VoucherId")', function() {
      ...
      //var instance = new Flipdish.VoucherUpdatedEvent();
