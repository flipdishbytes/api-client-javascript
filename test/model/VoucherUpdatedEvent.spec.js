...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.VoucherUpdatedEvent();
  });
  ...
  describe('VoucherUpdatedEvent', function() {
    it('should create an instance of VoucherUpdatedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.VoucherUpdatedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.VoucherUpdatedEvent);
    });
