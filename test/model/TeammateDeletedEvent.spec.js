...
(function(root, factory) {
  ...
  describe('(package)', function() {
    describe('TeammateDeletedEvent', function() {
      beforeEach(function() {
        instance = new Flipdish.TeammateDeletedEvent();
      });

      it('should create an instance of TeammateDeletedEvent', function() {
        // TODO: update the code to test TeammateDeletedEvent
        expect(instance).to.be.a(Flipdish.TeammateDeletedEvent);
      });
