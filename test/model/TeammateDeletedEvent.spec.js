...
(function(root, factory) {
  ...
  describe('TeammateDeletedEvent', function() {
    it('should create an instance of TeammateDeletedEvent', function() {
      // uncomment below and update the code to test TeammateDeletedEvent
      //var instane = new Flipdish.TeammateDeletedEvent();
    ...
    it('should have the property Teammate (base name: "Teammate")', function() {
      ...
      //var instance = new Flipdish.TeammateDeletedEvent();
