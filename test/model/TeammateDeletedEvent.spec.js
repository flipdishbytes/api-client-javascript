...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.TeammateDeletedEvent();
  });
  ...
  describe('TeammateDeletedEvent', function() {
    it('should create an instance of TeammateDeletedEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.TeammateDeletedEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.TeammateDeletedEvent);
    });
