...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.UserCreatedEvent();
  });
  ...
  describe('UserCreatedEvent', function() {
    it('should create an instance of UserCreatedEvent', function() {
      // uncomment below and update the code to test UserCreatedEvent
      //var instane = new Flipdish.UserCreatedEvent();
      //expect(instance).to.be.a(Flipdish.UserCreatedEvent);
    });
    ...
    it('should have the property EventName (base name: "EventName")', function() {
      ...
      //var instance = new Flipdish.UserCreatedEvent();
