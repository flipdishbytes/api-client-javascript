...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new FlipdishOpenApiV10.UserLoginEvent();
  });
  ...
  describe('UserLoginEvent', function() {
    it('should create an instance of UserLoginEvent', function() {
      ...
      //var instane = new FlipdishOpenApiV10.UserLoginEvent();
      //expect(instance).to.be.a(FlipdishOpenApiV10.UserLoginEvent);
    });
