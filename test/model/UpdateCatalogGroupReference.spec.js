...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new Flipdish.UpdateCatalogGroupReference();
  });
  ...
  describe('UpdateCatalogGroupReference', function() {
    it('should create an instance of UpdateCatalogGroupReference', function() {
      // uncomment below and update the code to test UpdateCatalogGroupReference
      //var instane = new Flipdish.UpdateCatalogGroupReference();
      //expect(instance).to.be.a(Flipdish.UpdateCatalogGroupReference);
    });
    ...
    it('should have the property CatalogGroupId (base name: "CatalogGroupId")', function() {
      ...
      //var instance = new Flipdish.UpdateCatalogGroupReference();
