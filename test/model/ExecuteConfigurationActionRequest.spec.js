...
(function(root, factory) {
  ...
  describe('ExecuteConfigurationActionRequest', function() {
    it('should create an instance of ExecuteConfigurationActionRequest', function() {
      // uncomment below and update the code to test ExecuteConfigurationActionRequest
      //var instane = new Flipdish.ExecuteConfigurationActionRequest();
      //expect(instance).to.be.a(Flipdish.ExecuteConfigurationActionRequest);
    });

    it('should have the property Key (base name: "Key")', function() {
      // uncomment below and update the code to test the property Key
      //var instance = new Flipdish.ExecuteConfigurationActionRequest();
