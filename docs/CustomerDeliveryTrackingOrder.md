# FlipdishOpenApiV10.CustomerDeliveryTrackingOrder
...
**orderLines** | [**[CustomerDeliveryTrackingOrderLine]**](CustomerDeliveryTrackingOrderLine.md) | Order lines of the order | [optional] 
**totalAmount** | **Number** | Total amount for the order including tax | [optional] 
**currency** | **String** | Currency | [optional] 
**latitude** | **Number** | Customer Location Latitude | [optional] 
**longitude** | **Number** | Customer Location Longitude | [optional] 
**placed** | **Date** | Order placed time | [optional] 
**requestedFor** | **Date** | Order requested for | [optional] 
