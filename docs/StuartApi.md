...
var apiInstance = new FlipdishOpenApiV10.StuartApi();
...
var stuartSettings = new FlipdishOpenApiV10.StuartSettings(); // StuartSettings | Stuart settings model
