...
var campaign = new Flipdish.LoyaltyCampaignBase(); // LoyaltyCampaignBase | Loyalty campaign details
...
var campaign = new Flipdish.RetentionCampaignBase(); // RetentionCampaignBase | Retention campaign details
