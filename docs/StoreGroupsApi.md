# FlipdishOpenApiV10.StoreGroupsApi
...
var apiInstance = new FlipdishOpenApiV10.StoreGroupsApi();

var appNameId = "appNameId_example"; // String | App Name Id

var storeGroup = new FlipdishOpenApiV10.StoreGroupBase(); // StoreGroupBase | Store group definition
...
var storeGroup = new FlipdishOpenApiV10.StoreGroupBase(); // StoreGroupBase | Store Group Delta
