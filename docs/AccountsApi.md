# FlipdishOpenApiV10.AccountsApi
...
var apiInstance = new FlipdishOpenApiV10.AccountsApi();
...
var changePasswordModel = new FlipdishOpenApiV10.ChangePasswordModel(); // ChangePasswordModel | Change password model
...
var changePasswordModel = new FlipdishOpenApiV10.SetPasswordWithPinModel(); // SetPasswordWithPinModel | Change password model
...
var createAccountModel = new FlipdishOpenApiV10.CreateAccountModel(); // CreateAccountModel | Create account model
...
var loginModel = new FlipdishOpenApiV10.LoginModel(); // LoginModel | Login model
...
var loginModel = new FlipdishOpenApiV10.LoginWithPinModel(); // LoginWithPinModel | Login model
...
var passwordResetModel = new FlipdishOpenApiV10.PasswordResetModel(); // PasswordResetModel | Password reset model
...
var requestLoginPinRequest = new FlipdishOpenApiV10.RequestLoginPinModel(); // RequestLoginPinModel | Request login PIN request
...
var requestPasswordResetModel = new FlipdishOpenApiV10.RequestPasswordResetModel(); // RequestPasswordResetModel | Request password reset model
...
var updateAccountModel = new FlipdishOpenApiV10.AccountDetailBase(); // AccountDetailBase | Update account model
