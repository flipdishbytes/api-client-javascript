...
var apiInstance = new Flipdish.DeliveryZoneApi();

var storeId = 56; // Number | Store Id to which the delivery zone will be added

var deliveryZoneBase = new Flipdish.DeliveryZoneBase(); // DeliveryZoneBase | Optional delivery zone, if not supplied will create a default zone
...
var deliveryZone = new Flipdish.DeliveryZoneBase(); // DeliveryZoneBase | Delta of delivery zone parameters that need to be changed
