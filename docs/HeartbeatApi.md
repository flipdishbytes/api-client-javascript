...
let apiInstance = new Flipdish.HeartbeatApi();
apiInstance.headHostname((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
...
let apiInstance = new Flipdish.HeartbeatApi();
apiInstance.headPing((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
...
let apiInstance = new Flipdish.HeartbeatApi();
apiInstance.hostname((error, data, response) => {
  if (error) {
    console.error(error);
  } else {
    console.log('API called successfully. Returned data: ' + data);
