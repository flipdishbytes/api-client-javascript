...
var menu = new Flipdish.CreateFullMenu(); // CreateFullMenu | Menu
...
var displayOrders = new Flipdish.MenuObjectDisplayOrders(); // MenuObjectDisplayOrders | Section Ids and their new display order
...
> RestApiArrayResultMenuElementEditResponse menusShowHideBulkItems(menuId, menuElements, hide, undoAfter)
...
var menuElements = [new Flipdish.MenuElementHide()]; // [MenuElementHide] | 

var hide = true; // Boolean | 

var undoAfter = 1.2; // Number | 
...
apiInstance.menusShowHideBulkItems(menuId, menuElements, hide, undoAfter, callback);
```
...
------------- | ------------- | ------------- | -------------
 **menuId** | **Number**|  | 
 **menuElements** | [**[MenuElementHide]**](MenuElementHide.md)|  | 
 **hide** | **Boolean**|  | 
 **undoAfter** | **Number**|  | 
...
var taxRate = new Flipdish.MenuTaxRate(); // MenuTaxRate | Tax Rate to Add/Update
