...
var settings = new Flipdish.StoreCloneSettings(); // StoreCloneSettings | Settings for cloning the store
...
var businessHoursOverride = new Flipdish.BusinessHoursOverrideBase(); // BusinessHoursOverrideBase | Business Hours Override
...
var store = new Flipdish.StoreCreateBase(); // StoreCreateBase | Store
...
var businessHoursPeriod = new Flipdish.BusinessHoursPeriodBase(); // BusinessHoursPeriodBase | Business Hours Period
...
var preOrderConfig = new Flipdish.PreOrderConfig(); // PreOrderConfig | Update pre order config values
...
var store = new Flipdish.StoreBase(); // StoreBase | Store
...
var storeAddress = new Flipdish.StoreAddressBase(); // StoreAddressBase | Store address
...
var coordinates = new Flipdish.Coordinates(); // Coordinates | Store address coordinates
