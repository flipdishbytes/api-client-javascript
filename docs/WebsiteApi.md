...
var apiInstance = new Flipdish.WebsiteApi();

var appId = "appId_example"; // String | Application identifier

var testimonial = new Flipdish.WebsiteTestimonialBase(); // WebsiteTestimonialBase | Testimonial to be added
...
var testimonial = new Flipdish.WebsiteTestimonialBase(); // WebsiteTestimonialBase | New values of the testimonial
...
var indexPage = new Flipdish.IndexPageBase(); // IndexPageBase | New index page definition
