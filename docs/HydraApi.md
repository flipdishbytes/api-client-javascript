...
var apiInstance = new Flipdish.HydraApi();
...
var emv = new Flipdish.EmvTerminal(); // EmvTerminal | 
...
var hydraRegistration = new Flipdish.HydraRegistrationRequest(); // HydraRegistrationRequest | 
