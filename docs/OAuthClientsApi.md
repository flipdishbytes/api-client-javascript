# FlipdishOpenApiV10.OAuthClientsApi
...
var apiInstance = new FlipdishOpenApiV10.OAuthClientsApi();
...
var oAuthApp = new FlipdishOpenApiV10.OAuthApp(); // OAuthApp | OAuth App
