...
var apiInstance = new FlipdishOpenApiV10.AppsApi();
...
var appConfigUpdate = new FlipdishOpenApiV10.AppConfigUpdateModel(); // AppConfigUpdateModel | Changes to the configuration
...
var languages = [new FlipdishOpenApiV10.Language()]; // [Language] | New list of languages
