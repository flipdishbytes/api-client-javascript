# FlipdishOpenApiV10.PayoutDetail

## Properties
Name | Type | Description | Notes
------------ | ------------- | ------------- | -------------
**payoutId** | **Number** | The id of the payout. | [optional] 
**bankAccountId** | **Number** | Bank account identifier | [optional] 
...
**payoutStores** | [**[PayoutStore]**](PayoutStore.md) | Payout information broken down by Store | [optional] 
