# FlipdishOpenApiV10.StripeCustomConnectApi
...
var apiInstance = new FlipdishOpenApiV10.StripeCustomConnectApi();
...
var stripeAccountLinkRequest = new FlipdishOpenApiV10.StripeAccountLinkRequest(); // StripeAccountLinkRequest | 
...
var updateRequest = new FlipdishOpenApiV10.BankAccountDetailsUpdateRequest(); // BankAccountDetailsUpdateRequest | fields to be updated
