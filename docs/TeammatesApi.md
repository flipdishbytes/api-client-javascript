# FlipdishOpenApiV10.TeammatesApi
...
var apiInstance = new FlipdishOpenApiV10.TeammatesApi();

var appId = "appId_example"; // String | Application identifier

var teammate = new FlipdishOpenApiV10.CreateTeammate(); // CreateTeammate | teammate model
...
var teammate = new FlipdishOpenApiV10.TeammateBase(); // TeammateBase | teammate model
