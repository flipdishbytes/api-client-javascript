...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CreateFullMenu', 'model/MenuBase', 'model/MenuObjectDisplayOrders', 'model/MenuTaxRate', 'model/Metadata', 'model/RestApiArrayResultAllMetadataResult', 'model/RestApiArrayResultMenuCheckpoint', 'model/RestApiArrayResultMenuStoreNames', 'model/RestApiArrayResultMenuSummary', 'model/RestApiArrayResultMenuTaxDetails', 'model/RestApiArrayResultMetadata', 'model/RestApiErrorResult', 'model/RestApiForbiddenResult', 'model/RestApiResultMenu', 'model/RestApiResultMetadata', 'model/RestApiStringResult', 'model/RestApiUnauthorizedResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CreateFullMenu'), require('../model/MenuBase'), require('../model/MenuObjectDisplayOrders'), require('../model/MenuTaxRate'), require('../model/Metadata'), require('../model/RestApiArrayResultAllMetadataResult'), require('../model/RestApiArrayResultMenuCheckpoint'), require('../model/RestApiArrayResultMenuStoreNames'), require('../model/RestApiArrayResultMenuSummary'), require('../model/RestApiArrayResultMenuTaxDetails'), require('../model/RestApiArrayResultMetadata'), require('../model/RestApiErrorResult'), require('../model/RestApiForbiddenResult'), require('../model/RestApiResultMenu'), require('../model/RestApiResultMetadata'), require('../model/RestApiStringResult'), require('../model/RestApiUnauthorizedResult'));
  } else {
    // Browser globals (root is window)
    if (!root.FlipdishOpenApiV10) {
      root.FlipdishOpenApiV10 = {};
    }
    root.FlipdishOpenApiV10.MenusApi = factory(root.FlipdishOpenApiV10.ApiClient, root.FlipdishOpenApiV10.CreateFullMenu, root.FlipdishOpenApiV10.MenuBase, root.FlipdishOpenApiV10.MenuObjectDisplayOrders, root.FlipdishOpenApiV10.MenuTaxRate, root.FlipdishOpenApiV10.Metadata, root.FlipdishOpenApiV10.RestApiArrayResultAllMetadataResult, root.FlipdishOpenApiV10.RestApiArrayResultMenuCheckpoint, root.FlipdishOpenApiV10.RestApiArrayResultMenuStoreNames, root.FlipdishOpenApiV10.RestApiArrayResultMenuSummary, root.FlipdishOpenApiV10.RestApiArrayResultMenuTaxDetails, root.FlipdishOpenApiV10.RestApiArrayResultMetadata, root.FlipdishOpenApiV10.RestApiErrorResult, root.FlipdishOpenApiV10.RestApiForbiddenResult, root.FlipdishOpenApiV10.RestApiResultMenu, root.FlipdishOpenApiV10.RestApiResultMetadata, root.FlipdishOpenApiV10.RestApiStringResult, root.FlipdishOpenApiV10.RestApiUnauthorizedResult);
  }
}(this, function(ApiClient, CreateFullMenu, MenuBase, MenuObjectDisplayOrders, MenuTaxRate, Metadata, RestApiArrayResultAllMetadataResult, RestApiArrayResultMenuCheckpoint, RestApiArrayResultMenuStoreNames, RestApiArrayResultMenuSummary, RestApiArrayResultMenuTaxDetails, RestApiArrayResultMetadata, RestApiErrorResult, RestApiForbiddenResult, RestApiResultMenu, RestApiResultMetadata, RestApiStringResult, RestApiUnauthorizedResult) {
  'use strict';
