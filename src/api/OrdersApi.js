...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Accept', 'model/Refund', 'model/Reject', 'model/RestApiErrorResult', 'model/RestApiForbiddenResult', 'model/RestApiPaginationResultOrder', 'model/RestApiPaginationResultOrderSummary', 'model/RestApiResultOrder', 'model/RestApiUnauthorizedResult'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Accept'), require('../model/Refund'), require('../model/Reject'), require('../model/RestApiErrorResult'), require('../model/RestApiForbiddenResult'), require('../model/RestApiPaginationResultOrder'), require('../model/RestApiPaginationResultOrderSummary'), require('../model/RestApiResultOrder'), require('../model/RestApiUnauthorizedResult'));
  } else {
    // Browser globals (root is window)
    if (!root.Flipdish) {
      root.Flipdish = {};
    }
    root.Flipdish.OrdersApi = factory(root.Flipdish.ApiClient, root.Flipdish.Accept, root.Flipdish.Refund, root.Flipdish.Reject, root.Flipdish.RestApiErrorResult, root.Flipdish.RestApiForbiddenResult, root.Flipdish.RestApiPaginationResultOrder, root.Flipdish.RestApiPaginationResultOrderSummary, root.Flipdish.RestApiResultOrder, root.Flipdish.RestApiUnauthorizedResult);
  }
}(this, function(ApiClient, Accept, Refund, Reject, RestApiErrorResult, RestApiForbiddenResult, RestApiPaginationResultOrder, RestApiPaginationResultOrderSummary, RestApiResultOrder, RestApiUnauthorizedResult) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/Accept} acceptObject Order accept parameters (eg: EstimatedMinutesForDelivery)
     ...
     */
    this.dispatchOrder = function(id, callback) {
      var postBody = null;
     ...
     * @param {Date} opts.from Order has been placed after this parameter value
     * @param {Date} opts.to Order has been placed before this parameter value
     ...
     */
    this.getOrdersSummary = function(appId, opts, callback) {
      opts = opts || {};
      var postBody = null;
      ...
      var contentTypes = [];
      var accepts = ['application/json', 'text/json', 'application/xml', 'text/xml'];
      var returnType = RestApiPaginationResultOrderSummary;
