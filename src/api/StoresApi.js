...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FlipdishOpenApiV10.StoresApi = factory(root.FlipdishOpenApiV10.ApiClient, root.FlipdishOpenApiV10.BusinessHoursOverrideBase, root.FlipdishOpenApiV10.BusinessHoursPeriodBase, root.FlipdishOpenApiV10.Coordinates, root.FlipdishOpenApiV10.PreOrderConfig, root.FlipdishOpenApiV10.RestApiArrayResultBusinessHoursPeriod, root.FlipdishOpenApiV10.RestApiArrayResultPreOrderTime, root.FlipdishOpenApiV10.RestApiArrayResultProcessingFeeConfig, root.FlipdishOpenApiV10.RestApiArrayResultRestApiDefaultResponse, root.FlipdishOpenApiV10.RestApiArrayResultStoreStatistics, root.FlipdishOpenApiV10.RestApiErrorResult, root.FlipdishOpenApiV10.RestApiForbiddenResult, root.FlipdishOpenApiV10.RestApiPaginationResultBusinessHoursOverride, root.FlipdishOpenApiV10.RestApiPaginationResultStore, root.FlipdishOpenApiV10.RestApiPaginationResultStoreHeader, root.FlipdishOpenApiV10.RestApiResultAssignedBankAccount, root.FlipdishOpenApiV10.RestApiResultBusinessHoursOverride, root.FlipdishOpenApiV10.RestApiResultBusinessHoursPeriod, root.FlipdishOpenApiV10.RestApiResultCoordinates, root.FlipdishOpenApiV10.RestApiResultPreOrderConfig, root.FlipdishOpenApiV10.RestApiResultProcessingFeeConfig, root.FlipdishOpenApiV10.RestApiResultStore, root.FlipdishOpenApiV10.RestApiResultStoreAddress, root.FlipdishOpenApiV10.RestApiResultStoreEndOfDayReport, root.FlipdishOpenApiV10.RestApiUnauthorizedResult, root.FlipdishOpenApiV10.StoreAddressBase, root.FlipdishOpenApiV10.StoreBase, root.FlipdishOpenApiV10.StoreCloneSettings, root.FlipdishOpenApiV10.StoreCreateBase);
  }
  ...
  var exports = function(apiClient) {
     ...
     * @param {module:model/String} deliveryType \"delivery\" or \"pickup\"
     * @param {Object} opts Optional parameters
     * @param {Number} opts.preOrderConfigLeadTimeMinutes Lead Time in Minutes
     * @param {Number} opts.preOrderConfigIntervalMinutes Interval in minutes
     * @param {Number} opts.preOrderConfigMaxOrderAheadDays Max Days to order ahead
     * @param {Boolean} opts.preOrderConfigIncludeAsap Show ASAP as option
     * @param {Boolean} opts.preOrderConfigIncludeMoreGranularInitialTime Granual Init' Time
     * @param {String} opts.preOrderConfigCutOffTimePreviousDayBasic Cut off time previous day
     * @param {String} opts.preOrderConfigCutOffTimeCurrentDayBasic Cut off time current day
     * @param {module:model/String} opts.preOrderConfigPreOrderTimeDisplayType Type of time displayed.
     * @param {Boolean} opts.preOrderConfigAlwaysAppearOpen Specifies whether a customer can pre-order outside the store opening hours or not.
     * @param {Boolean} opts.preOrderConfigRequireExplicitSelectAlways Force customer to select collection time.
    ...
    this.getPreOrderPreview = function(storeId, deliveryType, opts, callback) {
      ...
      var queryParams = {
        'preOrderConfig.leadTimeMinutes': opts['preOrderConfigLeadTimeMinutes'],
        'preOrderConfig.intervalMinutes': opts['preOrderConfigIntervalMinutes'],
        'preOrderConfig.maxOrderAheadDays': opts['preOrderConfigMaxOrderAheadDays'],
        'preOrderConfig.includeAsap': opts['preOrderConfigIncludeAsap'],
        'preOrderConfig.includeMoreGranularInitialTime': opts['preOrderConfigIncludeMoreGranularInitialTime'],
        'preOrderConfig.cutOffTimePreviousDayBasic': opts['preOrderConfigCutOffTimePreviousDayBasic'],
        'preOrderConfig.cutOffTimeCurrentDayBasic': opts['preOrderConfigCutOffTimeCurrentDayBasic'],
        'preOrderConfig.preOrderTimeDisplayType': opts['preOrderConfigPreOrderTimeDisplayType'],
        'preOrderConfig.alwaysAppearOpen': opts['preOrderConfigAlwaysAppearOpen'],
        'preOrderConfig.requireExplicitSelectAlways': opts['preOrderConfigRequireExplicitSelectAlways'],
      };
      var collectionQueryParams = {
      };
      var headerParams = {
