...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StoreKioskSetting', 'model/UserEventInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StoreKioskSetting'), require('./UserEventInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.FlipdishOpenApiV10) {
      root.FlipdishOpenApiV10 = {};
    }
    root.FlipdishOpenApiV10.StoreKioskSettingUpdatedEvent = factory(root.FlipdishOpenApiV10.ApiClient, root.FlipdishOpenApiV10.StoreKioskSetting, root.FlipdishOpenApiV10.UserEventInfo);
  }
}(this, function(ApiClient, StoreKioskSetting, UserEventInfo) {
  'use strict';
   ...
   */
  exports.prototype.storeKioskSetting = undefined;
