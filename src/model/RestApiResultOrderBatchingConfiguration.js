...
import OrderBatchingConfiguration from './OrderBatchingConfiguration';
 ...
 * @version 1.0.0
 */
class RestApiResultOrderBatchingConfiguration {
    /**
     ...
     * @param Data {module:model/OrderBatchingConfiguration} 
     */
    constructor(Data) { 
        
        RestApiResultOrderBatchingConfiguration.initialize(this, Data);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestApiResultOrderBatchingConfiguration();
 ...
 */
RestApiResultOrderBatchingConfiguration.prototype['Data'] = undefined;
...
export default RestApiResultOrderBatchingConfiguration;
