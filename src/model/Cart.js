...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/LineItem', 'model/Price'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./LineItem'), require('./Price'));
  } else {
    // Browser globals (root is window)
    if (!root.Flipdish) {
      root.Flipdish = {};
    }
    root.Flipdish.Cart = factory(root.Flipdish.ApiClient, root.Flipdish.LineItem, root.Flipdish.Price);
  }
}(this, function(ApiClient, LineItem, Price) {
  'use strict';
   ...
   */
  exports.prototype.CartAmount = undefined;
