...
/**
 * The PayoutRefund model module.
 * @module model/PayoutRefund
 * @version 1.0.0
 */
class PayoutRefund {
    /**
     * Constructs a new <code>PayoutRefund</code>.
     * Holds the information for a refund related to a payout
     * @alias module:model/PayoutRefund
     */
    constructor() { 
        
        PayoutRefund.initialize(this);
    }
    ...
    /**
     * Constructs a <code>PayoutRefund</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/PayoutRefund} obj Optional instance to populate.
     * @return {module:model/PayoutRefund} The populated <code>PayoutRefund</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new PayoutRefund();
            ...
            if (data.hasOwnProperty('TotalRefund')) {
                obj['TotalRefund'] = ApiClient.convertToType(data['TotalRefund'], 'Number');
            }
 ...
 */
PayoutRefund.prototype['OrderId'] = undefined;

/**
 * Order currency
 * @member {module:model/PayoutRefund.OrderCurrencyEnum} OrderCurrency
 */
PayoutRefund.prototype['OrderCurrency'] = undefined;

/**
 * The id of the payout the order is related to
 * @member {Number} PayoutId
 */
PayoutRefund.prototype['PayoutId'] = undefined;

/**
 * The date the order was placed
 * @member {Date} OrderDate
 */
PayoutRefund.prototype['OrderDate'] = undefined;

/**
 * Order type (online or cash)
 * @member {module:model/PayoutRefund.OrderTypeEnum} OrderType
 */
PayoutRefund.prototype['OrderType'] = undefined;

/**
 * The date the refund was done
 * @member {Date} RefundDate
 */
PayoutRefund.prototype['RefundDate'] = undefined;

/**
 * Store id
 * @member {Number} StoreId
 */
PayoutRefund.prototype['StoreId'] = undefined;

/**
 * Total refund amount
 * @member {Number} TotalRefund
 */
PayoutRefund.prototype['TotalRefund'] = undefined;

/**
 * Refunded fees amount
 * @member {Number} RefundedFees
 */
PayoutRefund.prototype['RefundedFees'] = undefined;

/**
 * Refunded amount
 * @member {Number} RefundedAmount
 */
PayoutRefund.prototype['RefundedAmount'] = undefined;

/**
 * Cash fee refunded to customer
 * @member {Number} CashFeeRefundedToCustomer
 */
PayoutRefund.prototype['CashFeeRefundedToCustomer'] = undefined;
 ...
 * @readonly
 */
PayoutRefund['OrderCurrencyEnum'] = {
