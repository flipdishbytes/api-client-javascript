...
/**
 * The StoreGroup model module.
 * @module model/StoreGroup
 * @version 1.0.0
 */
class StoreGroup {
    /**
     * Constructs a new <code>StoreGroup</code>.
     * Store Group
     * @alias module:model/StoreGroup
     */
    constructor() { 
        
        StoreGroup.initialize(this);
    }
    ...
    /**
     * Constructs a <code>StoreGroup</code> from a plain JavaScript object, optionally creating a new instance.
     * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
     * @param {Object} data The plain JavaScript object bearing properties of interest.
     * @param {module:model/StoreGroup} obj Optional instance to populate.
     * @return {module:model/StoreGroup} The populated <code>StoreGroup</code> instance.
     */
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StoreGroup();
 ...
 */
StoreGroup.prototype['StoreGroupId'] = undefined;

/**
 * Store Group rating
 * @member {Number} GeneralRating
 */
StoreGroup.prototype['GeneralRating'] = undefined;
 ...
 * @member {String} Name
 */
StoreGroup.prototype['Name'] = undefined;

/**
 * Currency used by the stores in this group
 * @member {module:model/StoreGroup.CurrencyEnum} Currency
 */
StoreGroup.prototype['Currency'] = undefined;
