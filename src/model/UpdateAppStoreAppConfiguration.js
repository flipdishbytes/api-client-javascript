 ...
 * @version 1.0.0
 */
class UpdateAppStoreAppConfiguration {
    /**
    ...
    constructor(IsEnabled) { 
        ...
        UpdateAppStoreAppConfiguration.initialize(this, IsEnabled);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new UpdateAppStoreAppConfiguration();
 ...
 */
UpdateAppStoreAppConfiguration.prototype['IsEnabled'] = undefined;

/**
 * @member {Array.<Number>} StoreIds
 */
UpdateAppStoreAppConfiguration.prototype['StoreIds'] = undefined;

/**
 * @member {Array.<module:model/Setting>} Settings
 */
UpdateAppStoreAppConfiguration.prototype['Settings'] = undefined;
...
export default UpdateAppStoreAppConfiguration;
