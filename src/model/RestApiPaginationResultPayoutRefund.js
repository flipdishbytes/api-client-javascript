...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/PayoutRefund'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./PayoutRefund'));
  } else {
    // Browser globals (root is window)
    if (!root.FlipdishOpenApiV10) {
      root.FlipdishOpenApiV10 = {};
    }
    root.FlipdishOpenApiV10.RestApiPaginationResultPayoutRefund = factory(root.FlipdishOpenApiV10.ApiClient, root.FlipdishOpenApiV10.PayoutRefund);
  }
}(this, function(ApiClient, PayoutRefund) {
  'use strict';
