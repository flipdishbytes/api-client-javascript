...
class ProcessingFeeConfig {
    ...
    constructor() { 
        ...
        ProcessingFeeConfig.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProcessingFeeConfig();
 ...
 */
ProcessingFeeConfig.prototype['StoreId'] = undefined;

/**
 * Payment account type
 * @member {module:model/ProcessingFeeConfig.PaymentAccountTypeEnum} PaymentAccountType
 */
ProcessingFeeConfig.prototype['PaymentAccountType'] = undefined;

/**
 * Percent fee to customer, including VAT
 * @member {Number} PercentFee
 */
ProcessingFeeConfig.prototype['PercentFee'] = undefined;

/**
 * Fixed fee to customer, including VAT
 * @member {Number} FixedFee
 */
ProcessingFeeConfig.prototype['FixedFee'] = undefined;
 ...
 * @readonly
 */
ProcessingFeeConfig['PaymentAccountTypeEnum'] = {
...
export default ProcessingFeeConfig;
