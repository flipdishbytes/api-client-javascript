 ...
 * @version 1.0.0
 */
class RestApiResultRestaurantVoucherPayGreenConfiguration {
    /**
     ...
     * @param Data {module:model/RestaurantVoucherPayGreenConfiguration} 
     */
    constructor(Data) { 
        
        RestApiResultRestaurantVoucherPayGreenConfiguration.initialize(this, Data);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new RestApiResultRestaurantVoucherPayGreenConfiguration();
 ...
 */
RestApiResultRestaurantVoucherPayGreenConfiguration.prototype['Data'] = undefined;
...
export default RestApiResultRestaurantVoucherPayGreenConfiguration;
