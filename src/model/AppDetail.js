...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.Flipdish.AppDetail = factory(root.Flipdish.ApiClient, root.Flipdish.FieldGroup);
  }
}(this, function(ApiClient, FieldGroup) {
  'use strict';

  /**
   * The AppDetail model module.
   * @module model/AppDetail
   * @version 1.0.0
   */

  /**
   * Constructs a new <code>AppDetail</code>.
   * Application
   * @alias module:model/AppDetail
   * @class
   * @param Id {String} Integration Public Id
   * @param ConfigurationType {module:model/AppDetail.ConfigurationTypeEnum} Configuration Type  <example>ExternalLink</example><example>FlipdishHosted</example>
   * @param StoreSelectorType {module:model/AppDetail.StoreSelectorTypeEnum} Store Selector Type
   * @param OAuthAppId {String} OAuth App Id
   * @param PermissionsType {module:model/AppDetail.PermissionsTypeEnum} Permissions Type
   * @param Name {String} Name
   * @param Description {String} Description
   * @param VerificationStatus {module:model/AppDetail.VerificationStatusEnum} Application verification status
   * @param Tags {Array.<String>} Tags
   * @param Regions {Array.<String>} Regions
   */
  var exports = function(Id, ConfigurationType, StoreSelectorType, OAuthAppId, PermissionsType, Name, Description, VerificationStatus, Tags, Regions) {
    this.Id = Id;
  ...
  /**
   * Constructs a <code>AppDetail</code> from a plain JavaScript object, optionally creating a new instance.
   * Copies all relevant properties from <code>data</code> to <code>obj</code> if supplied or a new instance if not.
   * @param {Object} data The plain JavaScript object bearing properties of interest.
   * @param {module:model/AppDetail} obj Optional instance to populate.
   * @return {module:model/AppDetail} The populated <code>AppDetail</code> instance.
   */
   ...
   * @member {module:model/AppDetail.ConfigurationTypeEnum} ConfigurationType
   */
  exports.prototype.ConfigurationType = undefined;

  /**
   * Store Selector Type
   * @member {module:model/AppDetail.StoreSelectorTypeEnum} StoreSelectorType
   */
   ...
   * @member {module:model/AppDetail.TeammateAppAccessLevelEnum} TeammateAppAccessLevel
   */
  exports.prototype.TeammateAppAccessLevel = undefined;

  /**
   * Permissions Type
   * @member {module:model/AppDetail.PermissionsTypeEnum} PermissionsType
   */
   ...
   * @member {module:model/AppDetail.VerificationStatusEnum} VerificationStatus
   */
