...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.FlipdishOpenApiV10.CspReportRequest = factory(root.FlipdishOpenApiV10.ApiClient, root.FlipdishOpenApiV10.CspReport);
  }
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('Csp-report'))
        obj.cspReport = CspReport.constructFromObject(data['Csp-report']);
    }
    return obj;
  }

  /**
   * @member {module:model/CspReport} cspReport
   */
  exports.prototype.cspReport = undefined;
