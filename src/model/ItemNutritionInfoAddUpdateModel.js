...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/NutritionInfoItemAddUpdateLabelModel'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./NutritionInfoItemAddUpdateLabelModel'));
  } else {
    // Browser globals (root is window)
    if (!root.Flipdish) {
      root.Flipdish = {};
    }
    root.Flipdish.ItemNutritionInfoAddUpdateModel = factory(root.Flipdish.ApiClient, root.Flipdish.NutritionInfoItemAddUpdateLabelModel);
  }
}(this, function(ApiClient, NutritionInfoItemAddUpdateLabelModel) {
  'use strict';
