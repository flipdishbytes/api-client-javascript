...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/FulfillmentStatesConfiguration'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./FulfillmentStatesConfiguration'));
  } else {
    // Browser globals (root is window)
    if (!root.Flipdish) {
      root.Flipdish = {};
    }
    root.Flipdish.RestApiResultFulfillmentStatesConfiguration = factory(root.Flipdish.ApiClient, root.Flipdish.FulfillmentStatesConfiguration);
  }
}(this, function(ApiClient, FulfillmentStatesConfiguration) {
  'use strict';
   ...
   * @class
   * @param Data {module:model/FulfillmentStatesConfiguration} Generic data object.
   */
