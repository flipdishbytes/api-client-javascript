...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/GoogleCoordinates'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./GoogleCoordinates'));
  } else {
    // Browser globals (root is window)
    if (!root.Flipdish) {
      root.Flipdish = {};
    }
    root.Flipdish.GoogleViewport = factory(root.Flipdish.ApiClient, root.Flipdish.GoogleCoordinates);
  }
}(this, function(ApiClient, GoogleCoordinates) {
  'use strict';
   ...
   */
  exports.prototype.Northeast = undefined;

  /**
   * @member {module:model/GoogleCoordinates} Southwest
   */
  exports.prototype.Southwest = undefined;
