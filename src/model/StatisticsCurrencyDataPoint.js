 ...
 * @version 1.0.0
 */
class StatisticsCurrencyDataPoint {
    /**
    ...
    constructor() { 
        ...
        StatisticsCurrencyDataPoint.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new StatisticsCurrencyDataPoint();
 ...
 */
StatisticsCurrencyDataPoint.prototype['Currency'] = undefined;

/**
 * Amount of users for this currency
 * @member {Number} UserCount
 */
StatisticsCurrencyDataPoint.prototype['UserCount'] = undefined;

/**
 * Amount of orders for this currency
 * @member {Number} OrderCount
 */
StatisticsCurrencyDataPoint.prototype['OrderCount'] = undefined;

/**
 * Value of orders for this currency
 * @member {Number} OrderValue
 */
StatisticsCurrencyDataPoint.prototype['OrderValue'] = undefined;
 ...
 * @readonly
 */
StatisticsCurrencyDataPoint['CurrencyEnum'] = {
...
export default StatisticsCurrencyDataPoint;
