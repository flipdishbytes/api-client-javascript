...
class MetafieldDefinition {
    ...
    constructor(Key, Name) { 
        ...
        MetafieldDefinition.initialize(this, Key, Name);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MetafieldDefinition();
 ...
 */
MetafieldDefinition.prototype['IsReadOnly'] = undefined;
 ...
 */
MetafieldDefinition.prototype['OwnerEntity'] = undefined;
 ...
 * @member {String} Key
 */
MetafieldDefinition.prototype['Key'] = undefined;

/**
 * The excepted type for the Value field
 * @member {module:model/MetafieldDefinition.ValueTypeEnum} ValueType
 */
MetafieldDefinition.prototype['ValueType'] = undefined;

/**
 * Field Name
 * @member {String} Name
 */
MetafieldDefinition.prototype['Name'] = undefined;

/**
 * Field Description
 * @member {String} Description
 */
MetafieldDefinition.prototype['Description'] = undefined;

/**
 * Enable Metafield Behaviors
 * @member {Array.<module:model/MetafieldDefinition.BehaviorsEnum>} Behaviors
 */
MetafieldDefinition.prototype['Behaviors'] = undefined;

/**
 * Metafield Recommendation Id
 * @member {Number} MetafieldDefinitionRecommendationId
 */
MetafieldDefinition.prototype['MetafieldDefinitionRecommendationId'] = undefined;
 ...
 * @readonly
 */
MetafieldDefinition['OwnerEntityEnum'] = {
 ...
 * @readonly
 */
MetafieldDefinition['ValueTypeEnum'] = {
 ...
 * @readonly
 */
MetafieldDefinition['BehaviorsEnum'] = {
