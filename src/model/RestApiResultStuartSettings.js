...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/StuartSettings'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./StuartSettings'));
  } else {
    // Browser globals (root is window)
    if (!root.FlipdishOpenApiV10) {
      root.FlipdishOpenApiV10 = {};
    }
    root.FlipdishOpenApiV10.RestApiResultStuartSettings = factory(root.FlipdishOpenApiV10.ApiClient, root.FlipdishOpenApiV10.StuartSettings);
  }
}(this, function(ApiClient, StuartSettings) {
  'use strict';
   ...
   * @class
   * @param data {module:model/StuartSettings} Generic data object.
   */
