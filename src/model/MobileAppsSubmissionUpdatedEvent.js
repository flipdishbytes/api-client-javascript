 ...
 * @version 1.0.0
 */
class MobileAppsSubmissionUpdatedEvent {
    /**
    ...
    constructor() { 
        ...
        MobileAppsSubmissionUpdatedEvent.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new MobileAppsSubmissionUpdatedEvent();
 ...
 */
MobileAppsSubmissionUpdatedEvent.prototype['EventName'] = undefined;

/**
 * Description
 * @member {String} Description
 */
MobileAppsSubmissionUpdatedEvent.prototype['Description'] = undefined;

/**
 * @member {module:model/UserEventInfo} User
 */
MobileAppsSubmissionUpdatedEvent.prototype['User'] = undefined;

/**
 * The identitfier of the event
 * @member {String} FlipdishEventId
 */
MobileAppsSubmissionUpdatedEvent.prototype['FlipdishEventId'] = undefined;

/**
 * The time of creation of the event
 * @member {Date} CreateTime
 */
MobileAppsSubmissionUpdatedEvent.prototype['CreateTime'] = undefined;

/**
 * Position
 * @member {Number} Position
 */
MobileAppsSubmissionUpdatedEvent.prototype['Position'] = undefined;

/**
 * App id
 * @member {String} AppId
 */
MobileAppsSubmissionUpdatedEvent.prototype['AppId'] = undefined;

/**
 * Org id
 * @member {String} OrgId
 */
MobileAppsSubmissionUpdatedEvent.prototype['OrgId'] = undefined;
...
export default MobileAppsSubmissionUpdatedEvent;
