...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/SmsInfo'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./SmsInfo'));
  } else {
    // Browser globals (root is window)
    if (!root.FlipdishOpenApiV10) {
      root.FlipdishOpenApiV10 = {};
    }
    root.FlipdishOpenApiV10.SmsReceivedEvent = factory(root.FlipdishOpenApiV10.ApiClient, root.FlipdishOpenApiV10.SmsInfo);
  }
}(this, function(ApiClient, SmsInfo) {
  'use strict';
   ...
   */
  exports.prototype.smsInfo = undefined;
